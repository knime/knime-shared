...
public final class NativeNodeLoader {
    ...
    public static FallibleNativeNodeDef load(final ConfigBaseRO workflowConfig, final File nodeDirectory,
        ...
        return new NativeNodeDefBuilder()//
            ...
            .setInternalNodeSubSettings(() -> ConfigurableNodeLoader.loadInternalNodeSubSettings(nodeConfig),
                DEFAULT_CONFIG_MAP) //
            .setModelSettings(() -> ConfigurableNodeLoader.loadModelSettings(nodeConfig), DEFAULT_CONFIG_MAP) //
            .setVariableSettings(() -> ConfigurableNodeLoader.loadVariableSettings(nodeConfig), DEFAULT_CONFIG_MAP)
