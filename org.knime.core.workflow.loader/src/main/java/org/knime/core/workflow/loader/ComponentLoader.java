...
import static org.knime.core.workflow.util.LoaderUtils.DEFAULT_CONFIG_MAP;
import static org.knime.core.workflow.util.LoaderUtils.DEFAULT_EMPTY_STRING;
import static org.knime.core.workflow.util.LoaderUtils.DEFAULT_NEGATIVE_INDEX;
import static org.knime.core.workflow.util.LoaderUtils.DEFAULT_TEMPLATE_LINK;
...
public final class ComponentLoader {
    ...
    public static FallibleComponentDef load(final ConfigBaseRO workflowConfig, final File nodeDirectory,
        ...
        var builder = new ComponentDefBuilder() //
            ...
            .setInternalNodeSubSettings(() -> ConfigurableNodeLoader.loadInternalNodeSubSettings(componentConfig),
                DEFAULT_CONFIG_MAP) //
            .setModelSettings(() -> ConfigurableNodeLoader.loadModelSettings(componentConfig), DEFAULT_CONFIG_MAP) //
            .setVariableSettings(() -> ConfigurableNodeLoader.loadVariableSettings(componentConfig), DEFAULT_CONFIG_MAP)
