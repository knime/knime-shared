 ...
 */
public class ConfigElementInt extends ConfigElementAbstractSimple<Integer> {
     ...
     */
    public ConfigElementInt(final String id, final int defaultValue,
    ...
    protected void save(final ConfigBaseWO settings) {
        settings.addInt(getID(), getValue());
    }
