...
/**
 * Item version representing the "most-recent" floating version.
 *
...
public record MostRecent() implements ItemVersion {
     ...
     *
     * @return the string identifier for the version representing the most-recent floating version
     */
    public static String getIdentifier() {
        return MOST_RECENT_IDENTIFIER;
    }
