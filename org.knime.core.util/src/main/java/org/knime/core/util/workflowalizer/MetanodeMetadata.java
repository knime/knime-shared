 ...
 */
public final class MetanodeMetadata extends AbstractWorkflowMetadata implements NodeMetadata {
    ...
    MetanodeMetadata(final Version version, final Version createdBy, final Optional<List<String>> annotations,
        ...
        final String type, final Optional<String> annotationText, final Optional<String> template) {
