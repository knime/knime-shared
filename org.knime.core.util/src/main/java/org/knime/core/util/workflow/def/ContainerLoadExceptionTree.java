 ...
 */
public final class ContainerLoadExceptionTree<K> implements LoadExceptionTree<K> {
     ...
     */
    private ContainerLoadExceptionTree(final LoadException supplierException,
    ...
    public static LoadExceptionTree<Integer> list(final List<?> elements, final LoadException supplierException) {
        ...
        return new ContainerLoadExceptionTree<>(supplierException, childSuppliers);
    }
    ...
    public static LoadExceptionTree<Integer> list(final Map<Integer, LoadException> exceptions) {
        return new ContainerLoadExceptionTree<>((LoadException)null, exceptions);
    }
    ...
    public static LoadExceptionTree<Integer> list(final Map<Integer, LoadException> exceptions,
        ...
        return new ContainerLoadExceptionTree<>(supplierException, exceptions);
    }
    ...
    public static <K, V> LoadExceptionTree<K> map(final Map<K, V> map, final LoadException containerSupplyException) {
        ...
        return new ContainerLoadExceptionTree<>(containerSupplyException, exceptionalChildren);
    }
    ...
    public static <K> LoadExceptionTree<K> tree(final LoadExceptionTree<K> tree, final LoadException supplyException) {
        return new ContainerLoadExceptionTree<>(supplyException, tree.getExceptionalChildren());
    }
}
