 ...
 */
public class ConfigElementDouble extends ConfigElementAbstractSimple<Double> {
     ...
     */
    public ConfigElementDouble(final String id, final double defaultValue,
    ...
    protected void save(final ConfigBaseWO settings) {
        settings.addDouble(getID(), getValue());
    }
