 ...
 */
public class ConfigElementLong extends ConfigElementAbstractSimple<Long> {
     ...
     */
    public ConfigElementLong(final String id, final long defaultValue,
    ...
    protected void save(final ConfigBaseWO settings) {
        settings.addLong(getID(), getValue());
    }
