...
public abstract class DelegatingAuthenticator extends Authenticator {
    ...
    protected PasswordAuthentication getPasswordAuthentication() {
        ...
        if (ownAuthenticaton.isPresent()) {
            return ownAuthenticaton.getAuthentication();
        }
     ...
     * @since 6.1
     */
    protected static final class OptionalAuthentication {

        private final boolean m_isPresent;

        private final PasswordAuthentication m_authentication;

        private OptionalAuthentication(final boolean isPresent, final PasswordAuthentication authentication) {
            m_isPresent = isPresent;
            m_authentication = authentication;
        }

        /**
         * Whether a (nullable) authentication value is present.
         *
         * @return is present?
         */
        ...
        /**
         * Retrieves the (nullable) stored value.
         *
