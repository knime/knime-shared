 ...
 * parse it into a list of {@code Predicate<URI>} rules.
 */
public interface WhiteListParser {

    /**
     * Parses a list of host name and IP filters into {@code Predicate<URI>}s.
     *
     * @param whiteList the string to parse
     * @return a list of {@code Predicate<URI>}s
     */
    List<Predicate<URI>> parseWhiteList(String whiteList);
}
