...
/**
 * Wrapper class for exceptions that can be thrown during the loading of a workflow. The exceptions that have been
 * caught during building a workflow description POJO (def) will be wrapped in an instance of this class.
 *
 * TODO javadoc update
 *
...
public class LoadException extends Exception implements LoadExceptionTree<Void>, LoadExceptionTreeProvider {
    ...
    // -----------------------------------------------------------------------------------------------------------------
    // LoadExceptionSupplier implementation
    // -----------------------------------------------------------------------------------------------------------------
