...
public abstract class AbstractConfigElement {
     ...
     * @param id The ID of this config element, must not be null.
     */
    public AbstractConfigElement(final String id) {
        if (id == null) {
     ...
     */
    protected abstract void save(final ConfigBaseWO settings);

    /** Load value from argument.
     * @param settings To load from.
     * @throws InvalidSettingsException If that fails.
     */
    protected abstract void load(final ConfigBaseRO settings)
