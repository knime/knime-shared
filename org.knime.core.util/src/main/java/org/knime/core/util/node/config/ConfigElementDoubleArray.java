 ...
 */
public class ConfigElementDoubleArray extends
        ConfigElementAbstractSimple<double[]> {
     ...
     */
    public ConfigElementDoubleArray(final String id,
    ...
    protected void save(final ConfigBaseWO settings) {
        settings.addDoubleArray(getID(), getValue());
    }
    ...
    protected void load(final ConfigBaseRO settings)
        ...
        setValue(settings.getDoubleArray(getID()));
    }
}
