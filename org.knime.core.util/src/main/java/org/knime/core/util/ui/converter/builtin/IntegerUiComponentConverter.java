...
/**
 * {@link UiComponentConverter} for integer parameters
 *
 * @author Carsten Haubold, KNIME GmbH, Konstanz, Germany
 */
public class IntegerUiComponentConverter extends AbstractNumericUiComponentConverter<Integer> {

    @Override
    public JsonObject getDialogNodeValueJsonFromJsonFormsModel(final JsonNode jsonFormsModel) {
        return JsonUtil.getProvider().createObjectBuilder().add("integer", jsonFormsModel.get(m_parameterName).asInt())
            .build();
    }
    ...
    @Override
    protected void insertNumeric(final ObjectNode jsonNode, final String name, final Integer value) {
