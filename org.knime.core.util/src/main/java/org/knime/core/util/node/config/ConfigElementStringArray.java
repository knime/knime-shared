 ...
 */
public class ConfigElementStringArray extends
        ConfigElementAbstractSimple<String[]> {
     ...
     */
    public ConfigElementStringArray(final String id,
    ...
    protected void save(final ConfigBaseWO settings) {
        settings.addStringArray(getID(), getValue());
    }
    ...
    protected void load(final ConfigBaseRO settings)
        ...
        setValue(settings.getStringArray(getID()));
    }
}
