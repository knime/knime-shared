 ...
 */
abstract class LeafConfigElement extends AbstractConfigElement {

    private final AbstractDisplayOption m_displayOptions;

    /** Create new leaf with given display options (or null).
     * @param id The id of the parameter.
     * @param displayOptions The display options.
     */
    LeafConfigElement(final String id,
    ...
    public AbstractDisplayOption getDisplayOptions() {
