...
/** Super class of all output elements. These elements are usually returned
 * by nodes representing results.
 * @author Bernd Wiswedel, KNIME.com, Zurich, Switzerland
 */
public abstract class AbstractQuickFormOutElement implements Serializable {
