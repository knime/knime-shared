 ...
 * On unconfigured JVMs or non-CRaC environments, {@link PhasedInitSupport#registerOrActivate(PhasedInit)} immediately
 * triggers the activation, ensuring compatibility without manual intervention.
 * </p>
 *
 * <p>
 * <b>Example:</b>
 ...
 *     public void run() {
 *         prepareContext();
 *         PhasedInitSupport.registerOrActivate(this);  // Defers or runs immediately
 *     }
 *
 *     &#64;Override
...
public interface PhasedInit<E extends Exception> {
     ...
     * registered}, this method will be invoked exactly once: either directly at registration time, or after a
     * checkpoint restore.
     *
     * </p>
     * <p>
