 ...
 */
public final class ConfigCharEntry extends AbstractConfigEntry {
     ...
     */
    public ConfigCharEntry(final String key, final char c) {
     ...
     */
    public ConfigCharEntry(final String key, final String c) {
        super(ConfigEntries.xchar, key);
        if (c.length() > 1) {
