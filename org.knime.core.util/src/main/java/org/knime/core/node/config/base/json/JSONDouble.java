...
/**
 * Jackson serializable representation of a double.
 * @author Bernd Wiswedel, KNIME.com, KNIME.com, Zurich
 */
@JsonTypeName("double")
public final class JSONDouble extends AbstractJSONEntry {
     ...
     * @param d The value
     */
    public JSONDouble(@JsonProperty("value") final double d) {
        m_double = d;
    }
    ...
    void addToConfigBase(final String key, final ConfigBase config, final BiConsumer<ConfigBase, AbstractConfigEntry> addToConfigCallBack) {
        addToConfigCallBack.accept(config, new ConfigDoubleEntry(key, m_double));
    }
    ...
    @Override
    public int hashCode() {
        return super.hashCode() ^ Double.hashCode(m_double);
    }
    ...
    public boolean equals(final Object obj) {
        ...
        return super.equals(obj) && ((JSONDouble)obj).m_double == m_double;
    }
}
