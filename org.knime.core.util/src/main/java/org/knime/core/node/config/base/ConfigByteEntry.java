 ...
 */
public final class ConfigByteEntry extends AbstractConfigEntry {
     ...
     */
    public ConfigByteEntry(final String key, final byte b) {
     ...
     */
    public ConfigByteEntry(final String key, final String b) {
        super(ConfigEntries.xbyte, key);
