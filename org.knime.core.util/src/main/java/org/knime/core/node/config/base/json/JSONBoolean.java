...
/**
 * Jackson serializable representation of a boolean.
 * @author Bernd Wiswedel, KNIME.com, KNIME.com, Zurich
 */
@JsonTypeName("boolean")
public final class JSONBoolean extends AbstractJSONEntry {
     ...
     * @param b The value
     */
    public JSONBoolean(@JsonProperty("value") final boolean b) {
        m_boolean = b;
    }
    ...
    void addToConfigBase(final String key, final ConfigBase config,
        ...
        addToConfigCallBack.accept(config, new ConfigBooleanEntry(key, m_boolean));
    }
    ...
    @Override
    public int hashCode() {
        return super.hashCode() ^ Boolean.hashCode(m_boolean);
    }
    ...
    public boolean equals(final Object obj) {
        ...
        return super.equals(obj) && ((JSONBoolean)obj).m_boolean == m_boolean;
    }
