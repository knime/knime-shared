 ...
 */
public final class ConfigBooleanEntry extends AbstractConfigEntry {
     ...
     */
    public ConfigBooleanEntry(final String key, final boolean b) {
     ...
     */
    public ConfigBooleanEntry(final String key, final String b) {
        super(ConfigEntries.xboolean, key);
