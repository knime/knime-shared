 ...
 */
public final class ConfigDoubleEntry extends AbstractConfigEntry {
     ...
     */
    public ConfigDoubleEntry(final String key, final double d) {
     ...
     */
    public ConfigDoubleEntry(final String key, final String d) {
        super(ConfigEntries.xdouble, key);
