 ...
 */
public final class ConfigLongEntry extends AbstractConfigEntry {
     ...
     */
    public ConfigLongEntry(final String key, final long l) {
     ...
     */
    public ConfigLongEntry(final String key, final String l) {
        super(ConfigEntries.xlong, key);
