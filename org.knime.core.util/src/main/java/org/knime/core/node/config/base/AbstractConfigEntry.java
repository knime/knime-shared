 ...
 */
public abstract class AbstractConfigEntry implements Serializable, TreeNode {
     ...
     */
    public final void setParent(final AbstractConfigEntry parent) {
        m_parent = parent;
    }
     ...
     */
    public final ConfigEntries getType() {
        return m_type;
    }
