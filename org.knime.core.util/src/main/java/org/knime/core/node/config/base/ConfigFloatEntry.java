 ...
 */
public final class ConfigFloatEntry extends AbstractConfigEntry {
     ...
     */
    public ConfigFloatEntry(final String key, final float f) {
     ...
     */
    public ConfigFloatEntry(final String key, final String d) {
        super(ConfigEntries.xfloat, key);
