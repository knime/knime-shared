...
class ApacheHttpClient5ProxyTest {
    ...
    void testRoutePlanner() throws IOException {
        ...
        GlobalProxyTestContext.withConfig(
    ...
    @Test
    void testCredentialsProvider() throws IOException {
    ...
    @Test
    void testNoConnectionReuse() throws IOException {
        // this target is always reachable (not only behind proxy)
        final var target = HttpbinTestContext.getHttpRequest5("https", "GET");
        final var authenticatedConfig = TinyproxyTestContext.getWithAuth(ProxyProtocol.HTTP);
