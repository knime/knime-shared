...
public class DefaultConfigValueShortDef extends DefaultConfigValueDef implements ConfigValueShortDef {
     ...
     */
    DefaultConfigValueShortDef(ConfigValueShortDefBuilder builder) {
     ...
     */
    DefaultConfigValueShortDef(ConfigValueShortDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof DefaultConfigValueShortDef){
            var childTree = ((DefaultConfigValueShortDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public DefaultConfigValueShortDef(ConfigValueShortDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_value = toCopy.getValue();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultConfigValueShortDef withException(ConfigValueShortDef toCopy, final LoadException exception) {
    ...
    public boolean equals(final Object o) {
        ...
        DefaultConfigValueShortDef other = (DefaultConfigValueShortDef)o;
