...
/**
 * ConfigValueBooleanDef
 *
 * @author Martin Horn, KNIME GmbH, Konstanz, Germany
 * @author Carl Witt, KNIME AG, Zurich, Switzerland
 * @author Dionysios Stolis, KNIME GmbH, Berlin, Germany
 */
@JsonDeserialize(as = FallibleConfigValueBooleanDef.class)
...
public interface ConfigValueBooleanDef extends ConfigValueDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link ConfigValueBooleanDef#getConfigType} 
          */
         CONFIG_TYPE,
         /** 
          * The type of this data attribute is {@link Boolean}.
          * Is is returned by {@link ConfigValueBooleanDef#isValue} 
          */
         VALUE,
;
    }
