...
public class DefaultConfigValueByteDef extends DefaultConfigValueDef implements ConfigValueByteDef {
     ...
     */
    DefaultConfigValueByteDef(ConfigValueByteDefBuilder builder) {
     ...
     */
    DefaultConfigValueByteDef(ConfigValueByteDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof DefaultConfigValueByteDef){
            var childTree = ((DefaultConfigValueByteDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public DefaultConfigValueByteDef(ConfigValueByteDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_value = toCopy.getValue();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultConfigValueByteDef withException(ConfigValueByteDef toCopy, final LoadException exception) {
    ...
    public boolean equals(final Object o) {
        ...
        DefaultConfigValueByteDef other = (DefaultConfigValueByteDef)o;
