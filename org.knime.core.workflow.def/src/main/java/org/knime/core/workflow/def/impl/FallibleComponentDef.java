...
public class FallibleComponentDef extends FallibleConfigurableNodeDef implements ComponentDef {

    /** this either points to a LoadException (which implements LoadExceptionTree<Void>) or to
     * a LoadExceptionTree<ComponentDef.Attribute> instance. */
     ...
     */
    FallibleComponentDef() {
        m_exceptionTree = Optional.empty();
    }

    /**
     * Builder constructor. Only for use in {@link ComponentDefBuilder}.
     * @param builder source
     */
    FallibleComponentDef(ComponentDefBuilder builder) {
     ...
     * Only for use in {@link ComponentDefBuilder}.
     ...
     */
    FallibleComponentDef(ComponentDef toCopy, final LoadException supplyException) {
        Objects.requireNonNull(supplyException);
        toCopy = Objects.requireNonNullElse(toCopy, new ComponentDefBuilder().build());
        ...
        if(toCopy instanceof FallibleComponentDef){
            var childTree = ((FallibleComponentDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleComponentDef(ComponentDef toCopy) {
        m_id = toCopy.getId();
        m_nodeType = toCopy.getNodeType();
        m_customDescription = toCopy.getCustomDescription();
        m_annotation = toCopy.getAnnotation();
    ...
    // -----------------------------------------------------------------------------------------------------------------
    // Factory method to attach a LoadException to an existing Component
    // -----------------------------------------------------------------------------------------------------------------
    /**
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleComponentDef withException(ComponentDef toCopy, final LoadException exception) {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ComponentDef.Attribute attribute){
        return m_exceptionTree.flatMap(t -> {
            if(t instanceof LoadException) return Optional.empty();
            // if the tree is not a leaf, it is typed to ComponentDef.Attribute
            return ((LoadExceptionTree<ComponentDef.Attribute>)t).getExceptionTree(attribute);
        });
    }
    ...
    public Optional<LoadException> getIdSupplyException(){
    	return getLoadExceptionTree(ComponentDef.Attribute.ID).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getNodeTypeSupplyException(){
    	return getLoadExceptionTree(ComponentDef.Attribute.NODE_TYPE).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getCustomDescriptionSupplyException(){
    	return getLoadExceptionTree(ComponentDef.Attribute.CUSTOM_DESCRIPTION).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getAnnotationSupplyException(){
    	return getLoadExceptionTree(ComponentDef.Attribute.ANNOTATION).flatMap(LoadExceptionTree::getSupplyException);
    }
    
     
    /**
     * @return If there are {@link LoadException}s related to the {@link NodeAnnotationDef} returned by {@link #getAnnotation()}, this
     * returns the annotation as FallibleNodeAnnotationDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleNodeAnnotationDef> getFaultyAnnotation(){
    	final var annotation = getAnnotation(); 
        if(annotation instanceof FallibleNodeAnnotationDef && ((FallibleNodeAnnotationDef)annotation).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleNodeAnnotationDef)annotation);
        }
    ...
    public Optional<LoadException> getUiInfoSupplyException(){
    	return getLoadExceptionTree(ComponentDef.Attribute.UI_INFO).flatMap(LoadExceptionTree::getSupplyException);
    }
    
     
    /**
     * @return If there are {@link LoadException}s related to the {@link NodeUIInfoDef} returned by {@link #getUiInfo()}, this
     * returns the uiInfo as FallibleNodeUIInfoDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleNodeUIInfoDef> getFaultyUiInfo(){
    	final var uiInfo = getUiInfo(); 
        if(uiInfo instanceof FallibleNodeUIInfoDef && ((FallibleNodeUIInfoDef)uiInfo).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleNodeUIInfoDef)uiInfo);
        }
    	return Optional.empty();
    }
    ...
    public Optional<LoadException> getLocksSupplyException(){
    	return getLoadExceptionTree(ComponentDef.Attribute.LOCKS).flatMap(LoadExceptionTree::getSupplyException);
    }
    
     
    /**
     * @return If there are {@link LoadException}s related to the {@link NodeLocksDef} returned by {@link #getLocks()}, this
     * returns the locks as FallibleNodeLocksDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleNodeLocksDef> getFaultyLocks(){
    	final var locks = getLocks(); 
        if(locks instanceof FallibleNodeLocksDef && ((FallibleNodeLocksDef)locks).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleNodeLocksDef)locks);
        }
    	return Optional.empty();
    }
    ...
    public Optional<LoadException> getJobManagerSupplyException(){
    	return getLoadExceptionTree(ComponentDef.Attribute.JOB_MANAGER).flatMap(LoadExceptionTree::getSupplyException);
    }
    
     
    /**
     * @return If there are {@link LoadException}s related to the {@link JobManagerDef} returned by {@link #getJobManager()}, this
     * returns the jobManager as FallibleJobManagerDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleJobManagerDef> getFaultyJobManager(){
    	final var jobManager = getJobManager(); 
        if(jobManager instanceof FallibleJobManagerDef && ((FallibleJobManagerDef)jobManager).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleJobManagerDef)jobManager);
        }
    	return Optional.empty();
    }
    ...
    public Optional<LoadException> getModelSettingsSupplyException(){
    	return getLoadExceptionTree(ComponentDef.Attribute.MODEL_SETTINGS).flatMap(LoadExceptionTree::getSupplyException);
    }
    
     
    /**
     * @return If there are {@link LoadException}s related to the {@link ConfigMapDef} returned by {@link #getModelSettings()}, this
     * returns the modelSettings as FallibleConfigMapDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleConfigMapDef> getFaultyModelSettings(){
    	final var modelSettings = getModelSettings(); 
        if(modelSettings instanceof FallibleConfigMapDef && ((FallibleConfigMapDef)modelSettings).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleConfigMapDef)modelSettings);
        }
    	return Optional.empty();
    }
    ...
    public Optional<LoadException> getInternalNodeSubSettingsSupplyException(){
    	return getLoadExceptionTree(ComponentDef.Attribute.INTERNAL_NODE_SUB_SETTINGS).flatMap(LoadExceptionTree::getSupplyException);
    }
     ...
     * returns the internalNodeSubSettings as FallibleConfigMapDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleConfigMapDef> getFaultyInternalNodeSubSettings(){
    	final var internalNodeSubSettings = getInternalNodeSubSettings(); 
        if(internalNodeSubSettings instanceof FallibleConfigMapDef && ((FallibleConfigMapDef)internalNodeSubSettings).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleConfigMapDef)internalNodeSubSettings);
        }
    	return Optional.empty();
    }
    ...
    public Optional<LoadException> getVariableSettingsSupplyException(){
    	return getLoadExceptionTree(ComponentDef.Attribute.VARIABLE_SETTINGS).flatMap(LoadExceptionTree::getSupplyException);
    }
    
     
    /**
     * @return If there are {@link LoadException}s related to the {@link ConfigMapDef} returned by {@link #getVariableSettings()}, this
     * returns the variableSettings as FallibleConfigMapDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleConfigMapDef> getFaultyVariableSettings(){
    	final var variableSettings = getVariableSettings(); 
        if(variableSettings instanceof FallibleConfigMapDef && ((FallibleConfigMapDef)variableSettings).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleConfigMapDef)variableSettings);
        }
    	return Optional.empty();
    }
    ...
    public Optional<LoadException> getWorkflowSupplyException(){
    	return getLoadExceptionTree(ComponentDef.Attribute.WORKFLOW).flatMap(LoadExceptionTree::getSupplyException);
    }
    
     
    /**
     * @return If there are {@link LoadException}s related to the {@link WorkflowDef} returned by {@link #getWorkflow()}, this
     * returns the workflow as FallibleWorkflowDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleWorkflowDef> getFaultyWorkflow(){
    	final var workflow = getWorkflow(); 
        if(workflow instanceof FallibleWorkflowDef && ((FallibleWorkflowDef)workflow).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleWorkflowDef)workflow);
        }
    	return Optional.empty();
    }
    ...
    public Optional<LoadException> getInPortsSupplyException(){
    	return getLoadExceptionTree(ComponentDef.Attribute.IN_PORTS).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadExceptionTree<Integer>> getInPortsExceptionTree(){
    	return getLoadExceptionTree(ComponentDef.Attribute.IN_PORTS).map(let -> (LoadExceptionTree<Integer>)let);
    }
    ...
    public Optional<LoadException> getOutPortsSupplyException(){
    	return getLoadExceptionTree(ComponentDef.Attribute.OUT_PORTS).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadExceptionTree<Integer>> getOutPortsExceptionTree(){
    	return getLoadExceptionTree(ComponentDef.Attribute.OUT_PORTS).map(let -> (LoadExceptionTree<Integer>)let);
    }
    ...
    public Optional<LoadException> getCipherSupplyException(){
    	return getLoadExceptionTree(ComponentDef.Attribute.CIPHER).flatMap(LoadExceptionTree::getSupplyException);
    }
    
     
    /**
     * @return If there are {@link LoadException}s related to the {@link CipherDef} returned by {@link #getCipher()}, this
     * returns the cipher as FallibleCipherDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleCipherDef> getFaultyCipher(){
    	final var cipher = getCipher(); 
        if(cipher instanceof FallibleCipherDef && ((FallibleCipherDef)cipher).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleCipherDef)cipher);
        }
    	return Optional.empty();
    }
    ...
    public Optional<LoadException> getVirtualInNodeIdSupplyException(){
    	return getLoadExceptionTree(ComponentDef.Attribute.VIRTUAL_IN_NODE_ID).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getVirtualOutNodeIdSupplyException(){
    	return getLoadExceptionTree(ComponentDef.Attribute.VIRTUAL_OUT_NODE_ID).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getMetadataSupplyException(){
    	return getLoadExceptionTree(ComponentDef.Attribute.METADATA).flatMap(LoadExceptionTree::getSupplyException);
    }
    
     
    /**
     * @return If there are {@link LoadException}s related to the {@link ComponentMetadataDef} returned by {@link #getMetadata()}, this
     * returns the metadata as FallibleComponentMetadataDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleComponentMetadataDef> getFaultyMetadata(){
    	final var metadata = getMetadata(); 
        if(metadata instanceof FallibleComponentMetadataDef && ((FallibleComponentMetadataDef)metadata).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleComponentMetadataDef)metadata);
        }
    	return Optional.empty();
    }
    ...
    public Optional<LoadException> getTemplateInfoSupplyException(){
    	return getLoadExceptionTree(ComponentDef.Attribute.TEMPLATE_INFO).flatMap(LoadExceptionTree::getSupplyException);
    }
    
     
    /**
     * @return If there are {@link LoadException}s related to the {@link TemplateInfoDef} returned by {@link #getTemplateInfo()}, this
     * returns the templateInfo as FallibleTemplateInfoDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleTemplateInfoDef> getFaultyTemplateInfo(){
    	final var templateInfo = getTemplateInfo(); 
        if(templateInfo instanceof FallibleTemplateInfoDef && ((FallibleTemplateInfoDef)templateInfo).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleTemplateInfoDef)templateInfo);
        }
    	return Optional.empty();
    }
    ...
    public Optional<LoadException> getDialogSettingsSupplyException(){
    	return getLoadExceptionTree(ComponentDef.Attribute.DIALOG_SETTINGS).flatMap(LoadExceptionTree::getSupplyException);
    }
     ...
     * returns the dialogSettings as FallibleComponentDialogSettingsDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleComponentDialogSettingsDef> getFaultyDialogSettings(){
    	final var dialogSettings = getDialogSettings(); 
        if(dialogSettings instanceof FallibleComponentDialogSettingsDef && ((FallibleComponentDialogSettingsDef)dialogSettings).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleComponentDialogSettingsDef)dialogSettings);
        }
    	return Optional.empty();
    }
