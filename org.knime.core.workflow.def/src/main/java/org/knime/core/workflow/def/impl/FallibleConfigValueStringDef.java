...
public class FallibleConfigValueStringDef extends FallibleConfigValueDef implements ConfigValueStringDef {

    /** this either points to a LoadException (which implements LoadExceptionTree<Void>) or to
     * a LoadExceptionTree<ConfigValueStringDef.Attribute> instance. */
    ...
    /**
     * Builder constructor. Only for use in {@link ConfigValueStringDefBuilder}.
     * @param builder source
     */
    FallibleConfigValueStringDef(ConfigValueStringDefBuilder builder) {
     ...
     * Only for use in {@link ConfigValueStringDefBuilder}.
     ...
     */
    FallibleConfigValueStringDef(ConfigValueStringDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleConfigValueStringDef){
            var childTree = ((FallibleConfigValueStringDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleConfigValueStringDef(ConfigValueStringDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_value = toCopy.getValue();
    ...
    // -----------------------------------------------------------------------------------------------------------------
    // Factory method to attach a LoadException to an existing ConfigValueString
    // -----------------------------------------------------------------------------------------------------------------
    /**
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleConfigValueStringDef withException(ConfigValueStringDef toCopy, final LoadException exception) {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueStringDef.Attribute attribute){
        return m_exceptionTree.flatMap(t -> {
            if(t instanceof LoadException) return Optional.empty();
            // if the tree is not a leaf, it is typed to ConfigValueStringDef.Attribute
            return ((LoadExceptionTree<ConfigValueStringDef.Attribute>)t).getExceptionTree(attribute);
        });
    }
    ...
    public Optional<LoadException> getConfigTypeSupplyException(){
    	return getLoadExceptionTree(ConfigValueStringDef.Attribute.CONFIG_TYPE).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getValueSupplyException(){
    	return getLoadExceptionTree(ConfigValueStringDef.Attribute.VALUE).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FallibleConfigValueStringDef)) {
            return false;
        }
        FallibleConfigValueStringDef other = (FallibleConfigValueStringDef)o;
