...
import org.knime.core.workflow.def.impl.FallibleCreatorDef;
 ...
 */
@JsonDeserialize(as = FallibleCreatorDef.class)
...
public interface CreatorDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link CreatorDef#getSavedWithVersion} 
          */
         SAVED_WITH_VERSION,
         /**  
          ...
          * Is is returned by {@link CreatorDef#isNightly} 
          */
         NIGHTLY,
;
    }
