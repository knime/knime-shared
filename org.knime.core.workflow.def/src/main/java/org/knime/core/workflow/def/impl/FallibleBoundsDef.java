...
public class FallibleBoundsDef implements BoundsDef {
     ...
     */
    FallibleBoundsDef(BoundsDefBuilder builder) {
     ...
     */
    FallibleBoundsDef(BoundsDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleBoundsDef){
            var childTree = ((FallibleBoundsDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleBoundsDef(BoundsDef toCopy) {
        m_location = toCopy.getLocation();
        m_width = toCopy.getWidth();
        m_height = toCopy.getHeight();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleBoundsDef withException(BoundsDef toCopy, final LoadException exception) {
