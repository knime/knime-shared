 ...
 */
@JsonDeserialize(as = FallibleConfigValueIntDef.class)
...
public interface ConfigValueIntDef extends ConfigValueDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link ConfigValueIntDef#getConfigType} 
          */
         CONFIG_TYPE,
         /** 
