...
public class FallibleMetaNodeDef extends FallibleBaseNodeDef implements MetaNodeDef {
     ...
     */
    FallibleMetaNodeDef(MetaNodeDefBuilder builder) {
     ...
     */
    FallibleMetaNodeDef(MetaNodeDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleMetaNodeDef){
            var childTree = ((FallibleMetaNodeDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleMetaNodeDef(MetaNodeDef toCopy) {
        m_id = toCopy.getId();
        m_nodeType = toCopy.getNodeType();
        m_customDescription = toCopy.getCustomDescription();
        m_annotation = toCopy.getAnnotation();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleMetaNodeDef withException(MetaNodeDef toCopy, final LoadException exception) {
     ...
     * returns the link as FallibleTemplateInfoDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleTemplateInfoDef> getFaultyLink(){
    	final var link = getLink(); 
        if(link instanceof FallibleTemplateInfoDef && ((FallibleTemplateInfoDef)link).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleTemplateInfoDef)link);
        }
    	return Optional.empty();
    }
     ...
     * returns the inPortsBarUIInfo as FallibleNodeUIInfoDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleNodeUIInfoDef> getFaultyInPortsBarUIInfo(){
    	final var inPortsBarUIInfo = getInPortsBarUIInfo(); 
        if(inPortsBarUIInfo instanceof FallibleNodeUIInfoDef && ((FallibleNodeUIInfoDef)inPortsBarUIInfo).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleNodeUIInfoDef)inPortsBarUIInfo);
        }
    	return Optional.empty();
    }
     ...
     * returns the outPortsBarUIInfo as FallibleNodeUIInfoDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleNodeUIInfoDef> getFaultyOutPortsBarUIInfo(){
    	final var outPortsBarUIInfo = getOutPortsBarUIInfo(); 
        if(outPortsBarUIInfo instanceof FallibleNodeUIInfoDef && ((FallibleNodeUIInfoDef)outPortsBarUIInfo).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleNodeUIInfoDef)outPortsBarUIInfo);
        }
    	return Optional.empty();
    }
