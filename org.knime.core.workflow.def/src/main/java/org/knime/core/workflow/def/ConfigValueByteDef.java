 ...
 */
@JsonDeserialize(as = FallibleConfigValueByteDef.class)
...
public interface ConfigValueByteDef extends ConfigValueDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link ConfigValueByteDef#getConfigType} 
          */
         CONFIG_TYPE,
         /** 
          * The type of this data attribute is {@link Integer}.
          * Is is returned by {@link ConfigValueByteDef#getValue} 
          */
         VALUE,
;
    }
