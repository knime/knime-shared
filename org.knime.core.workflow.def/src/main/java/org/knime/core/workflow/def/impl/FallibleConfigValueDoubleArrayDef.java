...
/**
 * FallibleConfigValueDoubleArrayDef
 *
...
public class FallibleConfigValueDoubleArrayDef extends FallibleConfigValueArrayDef implements ConfigValueDoubleArrayDef {
     ...
     */
    FallibleConfigValueDoubleArrayDef(ConfigValueDoubleArrayDefBuilder builder) {
     ...
     */
    FallibleConfigValueDoubleArrayDef(ConfigValueDoubleArrayDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleConfigValueDoubleArrayDef){
            var childTree = ((FallibleConfigValueDoubleArrayDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleConfigValueDoubleArrayDef(ConfigValueDoubleArrayDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_array = toCopy.getArray();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleConfigValueDoubleArrayDef withException(ConfigValueDoubleArrayDef toCopy, final LoadException exception) {
