...
/**
 * ConfigValueStringDef
 *
 * @author Martin Horn, KNIME GmbH, Konstanz, Germany
 * @author Carl Witt, KNIME AG, Zurich, Switzerland
 * @author Dionysios Stolis, KNIME GmbH, Berlin, Germany
 */
@JsonDeserialize(as = FallibleConfigValueStringDef.class)
...
public interface ConfigValueStringDef extends ConfigValueDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link ConfigValueStringDef#getConfigType} 
          */
         CONFIG_TYPE,
         /** 
          * The type of this data attribute is {@link String}.
          * Is is returned by {@link ConfigValueStringDef#getValue} 
          */
         VALUE,
;
    }
