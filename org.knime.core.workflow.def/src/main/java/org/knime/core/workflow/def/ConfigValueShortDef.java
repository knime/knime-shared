 ...
 */
@JsonDeserialize(as = FallibleConfigValueShortDef.class)
...
public interface ConfigValueShortDef extends ConfigValueDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link ConfigValueShortDef#getConfigType} 
          */
         CONFIG_TYPE,
         /** 
          * The type of this data attribute is {@link Integer}.
          * Is is returned by {@link ConfigValueShortDef#getValue} 
          */
         VALUE,
;
    }
