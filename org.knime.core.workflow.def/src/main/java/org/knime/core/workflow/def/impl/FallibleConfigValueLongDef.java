...
public class FallibleConfigValueLongDef extends FallibleConfigValueDef implements ConfigValueLongDef {
     ...
     */
    FallibleConfigValueLongDef(ConfigValueLongDefBuilder builder) {
     ...
     */
    FallibleConfigValueLongDef(ConfigValueLongDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleConfigValueLongDef){
            var childTree = ((FallibleConfigValueLongDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleConfigValueLongDef(ConfigValueLongDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_value = toCopy.getValue();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleConfigValueLongDef withException(ConfigValueLongDef toCopy, final LoadException exception) {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueLongDef.Attribute attribute){
        return m_exceptionTree.flatMap(t -> {
            ...
            return ((LoadExceptionTree<ConfigValueLongDef.Attribute>)t).getExceptionTree(attribute);
        });
    }
