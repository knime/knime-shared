...
public class FallibleConfigValueByteArrayDef extends FallibleConfigValueArrayDef implements ConfigValueByteArrayDef {
     ...
     */
    FallibleConfigValueByteArrayDef() {
     ...
     */
    FallibleConfigValueByteArrayDef(ConfigValueByteArrayDefBuilder builder) {
     ...
     */
    FallibleConfigValueByteArrayDef(ConfigValueByteArrayDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleConfigValueByteArrayDef){
            var childTree = ((FallibleConfigValueByteArrayDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleConfigValueByteArrayDef(ConfigValueByteArrayDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_array = toCopy.getArray();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleConfigValueByteArrayDef withException(ConfigValueByteArrayDef toCopy, final LoadException exception) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FallibleConfigValueByteArrayDef)) {
            return false;
        }
        FallibleConfigValueByteArrayDef other = (FallibleConfigValueByteArrayDef)o;
