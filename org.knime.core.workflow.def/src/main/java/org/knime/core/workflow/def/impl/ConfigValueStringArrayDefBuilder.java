...
/**
 * ConfigValueStringArrayDefBuilder
...
public class ConfigValueStringArrayDefBuilder {
     ...
     */
    Map<ConfigValueStringArrayDef.Attribute, LoadExceptionTree<?>> m_exceptionalChildren = new java.util.EnumMap<>(ConfigValueStringArrayDef.Attribute.class);
     ...
     */
    java.util.List<String> m_array = new java.util.ArrayList<>();
    /** Temporarily holds onto elements set as a whole with setArray these are added to m_array in build */
    private java.util.List<String> m_arrayBulkElements = new java.util.ArrayList<>();
     ...
     */
    public ConfigValueStringArrayDefBuilder() {
    }

    /**
     * Create a new builder from an existing instance.
     */
    public ConfigValueStringArrayDefBuilder(final ConfigValueStringArrayDef toCopy) {
     ...
     */ 
    public ConfigValueStringArrayDefBuilder setConfigType(final String configType) {
     ...
     * {@code hasExceptions(ConfigValueStringArrayDef.Attribute.CONFIG_TYPE)} will return true and and
     * {@code getExceptionalChildren().get(ConfigValueStringArrayDef.Attribute.CONFIG_TYPE)} will return the exception.
     * 
     * @param configType see {@link ConfigValueStringArrayDef#getConfigType}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setConfigType(String)
     */
    public ConfigValueStringArrayDefBuilder setConfigType(final FallibleSupplier<String> configType, String defaultValue) {
        ...
        try {
            ...
            m_exceptionalChildren.put(ConfigValueStringArrayDef.Attribute.CONFIG_TYPE, supplyException);
	    }   
        return this;
    }
    // -----------------------------------------------------------------------------------------------------------------
     ...
     */
    public ConfigValueStringArrayDefBuilder setArray(final java.util.List<String> array) {
        setArray(() -> array);
        return this;
    }
     ...
     * {@code hasExceptions(ConfigValueStringArrayDef.Attribute.ARRAY)} will return true and and
     * {@code getExceptionalChildren().get(ConfigValueStringArrayDef.Attribute.ARRAY)} will return the exception.
     * 
     * @param array see {@link ConfigValueStringArrayDef#getArray}
     * 
     * @return this builder for fluent API.
     * @see #setArray(java.util.List<String>)
     */
    public ConfigValueStringArrayDefBuilder setArray(final FallibleSupplier<java.util.List<String>> array) {
     ...
     * @return this builder for fluent API
     */
    public ConfigValueStringArrayDefBuilder addToArray(String value){
    	addToArray(() -> value, /* default value will not be used */ value);
        return this;
    }
    
    /**
     * Adds the return value of the fallible supplier to the list returned by {@link ConfigValueStringArrayDef#getArray}. If the 
    ...
    // -----------------------------------------------------------------------------------------------------------------
    /**
	 * @return the {@link ConfigValueStringArrayDef} created from the data passed to the setters. Implements 
     *      {@link LoadExceptionTree} to provide access to any load exceptions that have occurred during evaluation
     *      of the suppliers passed to the setters.
	 */
    public FallibleConfigValueStringArrayDef build() {
        ...
        return new FallibleConfigValueStringArrayDef(this);
    }    
