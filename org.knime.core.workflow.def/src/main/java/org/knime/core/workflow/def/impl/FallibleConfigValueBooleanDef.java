...
public class FallibleConfigValueBooleanDef extends FallibleConfigValueDef implements ConfigValueBooleanDef {

    /** this either points to a LoadException (which implements LoadExceptionTree<Void>) or to
     * a LoadExceptionTree<ConfigValueBooleanDef.Attribute> instance. */
    ...
    /**
     * Builder constructor. Only for use in {@link ConfigValueBooleanDefBuilder}.
     * @param builder source
     */
    FallibleConfigValueBooleanDef(ConfigValueBooleanDefBuilder builder) {
     ...
     * Only for use in {@link ConfigValueBooleanDefBuilder}.
     ...
     */
    FallibleConfigValueBooleanDef(ConfigValueBooleanDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleConfigValueBooleanDef){
            var childTree = ((FallibleConfigValueBooleanDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleConfigValueBooleanDef(ConfigValueBooleanDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_value = toCopy.isValue();
    ...
    // -----------------------------------------------------------------------------------------------------------------
    // Factory method to attach a LoadException to an existing ConfigValueBoolean
    // -----------------------------------------------------------------------------------------------------------------
    /**
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleConfigValueBooleanDef withException(ConfigValueBooleanDef toCopy, final LoadException exception) {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueBooleanDef.Attribute attribute){
        return m_exceptionTree.flatMap(t -> {
            if(t instanceof LoadException) return Optional.empty();
            // if the tree is not a leaf, it is typed to ConfigValueBooleanDef.Attribute
            return ((LoadExceptionTree<ConfigValueBooleanDef.Attribute>)t).getExceptionTree(attribute);
        });
    }
    ...
    public Optional<LoadException> getConfigTypeSupplyException(){
    	return getLoadExceptionTree(ConfigValueBooleanDef.Attribute.CONFIG_TYPE).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getValueSupplyException(){
    	return getLoadExceptionTree(ConfigValueBooleanDef.Attribute.VALUE).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FallibleConfigValueBooleanDef)) {
            return false;
        }
        FallibleConfigValueBooleanDef other = (FallibleConfigValueBooleanDef)o;
