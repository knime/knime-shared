...
public class FallibleNativeNodeDef extends FallibleConfigurableNodeDef implements NativeNodeDef {
     ...
     */
    FallibleNativeNodeDef(NativeNodeDefBuilder builder) {
     ...
     */
    FallibleNativeNodeDef(NativeNodeDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleNativeNodeDef){
            var childTree = ((FallibleNativeNodeDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleNativeNodeDef(NativeNodeDef toCopy) {
        m_id = toCopy.getId();
        m_nodeType = toCopy.getNodeType();
        m_customDescription = toCopy.getCustomDescription();
        m_annotation = toCopy.getAnnotation();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleNativeNodeDef withException(NativeNodeDef toCopy, final LoadException exception) {
     ...
     * returns the factorySettings as FallibleConfigMapDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleConfigMapDef> getFaultyFactorySettings(){
    	final var factorySettings = getFactorySettings(); 
        if(factorySettings instanceof FallibleConfigMapDef && ((FallibleConfigMapDef)factorySettings).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleConfigMapDef)factorySettings);
        }
    	return Optional.empty();
    }
     ...
     * returns the feature as FallibleVendorDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleVendorDef> getFaultyFeature(){
    	final var feature = getFeature(); 
        if(feature instanceof FallibleVendorDef && ((FallibleVendorDef)feature).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleVendorDef)feature);
        }
    	return Optional.empty();
    }
     ...
     * returns the bundle as FallibleVendorDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleVendorDef> getFaultyBundle(){
    	final var bundle = getBundle(); 
        if(bundle instanceof FallibleVendorDef && ((FallibleVendorDef)bundle).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleVendorDef)bundle);
        }
    	return Optional.empty();
    }
     ...
     * returns the nodeCreationConfig as FallibleConfigMapDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleConfigMapDef> getFaultyNodeCreationConfig(){
    	final var nodeCreationConfig = getNodeCreationConfig(); 
        if(nodeCreationConfig instanceof FallibleConfigMapDef && ((FallibleConfigMapDef)nodeCreationConfig).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleConfigMapDef)nodeCreationConfig);
        }
    	return Optional.empty();
    }
     ...
     * returns the filestore as FallibleFilestoreDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleFilestoreDef> getFaultyFilestore(){
    	final var filestore = getFilestore(); 
        if(filestore instanceof FallibleFilestoreDef && ((FallibleFilestoreDef)filestore).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleFilestoreDef)filestore);
        }
    	return Optional.empty();
    }
