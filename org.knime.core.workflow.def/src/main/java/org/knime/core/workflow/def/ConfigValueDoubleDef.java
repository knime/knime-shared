...
/**
 * ConfigValueDoubleDef
 *
 * @author Martin Horn, KNIME GmbH, Konstanz, Germany
 * @author Carl Witt, KNIME AG, Zurich, Switzerland
 * @author Dionysios Stolis, KNIME GmbH, Berlin, Germany
 */
@JsonDeserialize(as = FallibleConfigValueDoubleDef.class)
...
public interface ConfigValueDoubleDef extends ConfigValueDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link ConfigValueDoubleDef#getConfigType} 
          */
         CONFIG_TYPE,
         /** 
