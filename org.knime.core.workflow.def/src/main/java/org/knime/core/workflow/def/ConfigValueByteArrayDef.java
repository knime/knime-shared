 ...
 */
@JsonDeserialize(as = FallibleConfigValueByteArrayDef.class)
...
public interface ConfigValueByteArrayDef extends ConfigValueArrayDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link ConfigValueByteArrayDef#getConfigType} 
          */
         CONFIG_TYPE,
         /** 
          * The type of this data attribute is {@link byte[]}.
          * Is is returned by {@link ConfigValueByteArrayDef#getArray} 
          */
         ARRAY,
;
    }
