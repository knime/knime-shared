...
/**
 * FallibleConfigValueBooleanArrayDef
 *
...
public class FallibleConfigValueBooleanArrayDef extends FallibleConfigValueArrayDef implements ConfigValueBooleanArrayDef {
     ...
     */
    FallibleConfigValueBooleanArrayDef(ConfigValueBooleanArrayDefBuilder builder) {
     ...
     */
    FallibleConfigValueBooleanArrayDef(ConfigValueBooleanArrayDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleConfigValueBooleanArrayDef){
            var childTree = ((FallibleConfigValueBooleanArrayDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleConfigValueBooleanArrayDef(ConfigValueBooleanArrayDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_array = toCopy.getArray();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleConfigValueBooleanArrayDef withException(ConfigValueBooleanArrayDef toCopy, final LoadException exception) {
