...
public class FallibleFlowVariableDef implements FlowVariableDef {
     ...
     */
    FallibleFlowVariableDef(FlowVariableDefBuilder builder) {
     ...
     */
    FallibleFlowVariableDef(FlowVariableDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleFlowVariableDef){
            var childTree = ((FallibleFlowVariableDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleFlowVariableDef(FlowVariableDef toCopy) {
        m_name = toCopy.getName();
        m_propertyClass = toCopy.getPropertyClass();
        m_value = toCopy.getValue();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleFlowVariableDef withException(FlowVariableDef toCopy, final LoadException exception) {
     ...
     * returns the value as FallibleConfigMapDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    public Optional<FallibleConfigMapDef> getFaultyValue(){
    	final var value = getValue(); 
        if(value instanceof FallibleConfigMapDef && ((FallibleConfigMapDef)value).getLoadExceptionTree().map(LoadExceptionTree::hasExceptions).orElse(false)) {
            return Optional.of((FallibleConfigMapDef)value);
        }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FallibleFlowVariableDef)) {
            return false;
        }
        FallibleFlowVariableDef other = (FallibleFlowVariableDef)o;
