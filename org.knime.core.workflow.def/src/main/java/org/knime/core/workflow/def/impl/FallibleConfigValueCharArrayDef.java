...
/**
 * FallibleConfigValueCharArrayDef
 *
...
public class FallibleConfigValueCharArrayDef extends FallibleConfigValueArrayDef implements ConfigValueCharArrayDef {

    /** this either points to a LoadException (which implements LoadExceptionTree<Void>) or to
     * a LoadExceptionTree<ConfigValueCharArrayDef.Attribute> instance. */
    ...
    /**
     * Builder constructor. Only for use in {@link ConfigValueCharArrayDefBuilder}.
     * @param builder source
     */
    FallibleConfigValueCharArrayDef(ConfigValueCharArrayDefBuilder builder) {
     ...
     * Only for use in {@link ConfigValueCharArrayDefBuilder}.
     ...
     */
    FallibleConfigValueCharArrayDef(ConfigValueCharArrayDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleConfigValueCharArrayDef){
            var childTree = ((FallibleConfigValueCharArrayDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleConfigValueCharArrayDef(ConfigValueCharArrayDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_array = toCopy.getArray();
    ...
    // -----------------------------------------------------------------------------------------------------------------
    // Factory method to attach a LoadException to an existing ConfigValueCharArray
    // -----------------------------------------------------------------------------------------------------------------
    /**
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleConfigValueCharArrayDef withException(ConfigValueCharArrayDef toCopy, final LoadException exception) {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueCharArrayDef.Attribute attribute){
        return m_exceptionTree.flatMap(t -> {
            if(t instanceof LoadException) return Optional.empty();
            // if the tree is not a leaf, it is typed to ConfigValueCharArrayDef.Attribute
            return ((LoadExceptionTree<ConfigValueCharArrayDef.Attribute>)t).getExceptionTree(attribute);
        });
    }
    ...
    public Optional<LoadException> getConfigTypeSupplyException(){
    	return getLoadExceptionTree(ConfigValueCharArrayDef.Attribute.CONFIG_TYPE).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getArraySupplyException(){
    	return getLoadExceptionTree(ConfigValueCharArrayDef.Attribute.ARRAY).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadExceptionTree<Integer>> getArrayExceptionTree(){
    	return getLoadExceptionTree(ConfigValueCharArrayDef.Attribute.ARRAY).map(les -> (LoadExceptionTree<Integer>)les);
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FallibleConfigValueCharArrayDef)) {
            return false;
        }
        FallibleConfigValueCharArrayDef other = (FallibleConfigValueCharArrayDef)o;
