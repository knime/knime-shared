 ...
 */
@JsonDeserialize(as = FallibleConfigValueLongDef.class)
...
public interface ConfigValueLongDef extends ConfigValueDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link ConfigValueLongDef#getConfigType} 
          */
         CONFIG_TYPE,
         /** 
          * The type of this data attribute is {@link Long}.
          * Is is returned by {@link ConfigValueLongDef#getValue} 
          */
         VALUE,
;
    }
