...
public class FallibleConfigValueFloatDef extends FallibleConfigValueDef implements ConfigValueFloatDef {
     ...
     */
    FallibleConfigValueFloatDef(ConfigValueFloatDefBuilder builder) {
     ...
     */
    FallibleConfigValueFloatDef(ConfigValueFloatDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleConfigValueFloatDef){
            var childTree = ((FallibleConfigValueFloatDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleConfigValueFloatDef(ConfigValueFloatDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_value = toCopy.getValue();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleConfigValueFloatDef withException(ConfigValueFloatDef toCopy, final LoadException exception) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FallibleConfigValueFloatDef)) {
            return false;
        }
        FallibleConfigValueFloatDef other = (FallibleConfigValueFloatDef)o;
