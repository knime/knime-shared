...
import org.knime.core.workflow.def.impl.FalliblePortTypeDef;
 ...
 */
@JsonDeserialize(as = FalliblePortTypeDef.class)
...
public interface PortTypeDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          *
          * The type of this data attribute is {@link String}.
          * Is is returned by {@link PortTypeDef#getPortObjectSpecClass} 
          */
         PORT_OBJECT_SPEC_CLASS,
         /** 
          * The type of this data attribute is {@link Integer}.
          * Is is returned by {@link PortTypeDef#getColor} 
          */
         COLOR,
         /**  
          ...
          *
          * The type of this data attribute is {@link String}.
          * Is is returned by {@link PortTypeDef#getName} 
          */
         NAME,
;
    }
