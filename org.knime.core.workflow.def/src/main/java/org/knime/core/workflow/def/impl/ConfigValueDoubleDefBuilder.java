...
public class ConfigValueDoubleDefBuilder {
     ...
     */
    Map<ConfigValueDoubleDef.Attribute, LoadExceptionTree<?>> m_exceptionalChildren = new java.util.EnumMap<>(ConfigValueDoubleDef.Attribute.class);
     ...
     */
    public ConfigValueDoubleDefBuilder() {
    }
     ...
     * {@code hasExceptions(ConfigValueDoubleDef.Attribute.CONFIG_TYPE)} will return true and and
     * {@code getExceptionalChildren().get(ConfigValueDoubleDef.Attribute.CONFIG_TYPE)} will return the exception.
     * 
     * @param configType see {@link ConfigValueDoubleDef#getConfigType}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setConfigType(String)
     */
    public ConfigValueDoubleDefBuilder setConfigType(final FallibleSupplier<String> configType, String defaultValue) {
     ...
     * Sets the field using a supplier that may throw an exception. If an exception is thrown, it is recorded and can
     * be accessed through {@link LoadExceptionTree} interface of the instance build by this builder.
     * {@code hasExceptions(ConfigValueDoubleDef.Attribute.VALUE)} will return true and and
     * {@code getExceptionalChildren().get(ConfigValueDoubleDef.Attribute.VALUE)} will return the exception.
     * 
     * @param value see {@link ConfigValueDoubleDef#getValue}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setValue(Double)
     */
    public ConfigValueDoubleDefBuilder setValue(final FallibleSupplier<Double> value, Double defaultValue) {
    ...
    // -----------------------------------------------------------------------------------------------------------------
    /**
	 * @return the {@link ConfigValueDoubleDef} created from the data passed to the setters. Implements 
