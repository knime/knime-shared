...
/**
 * FallibleConfigValueShortArrayDef
 *
...
public class FallibleConfigValueShortArrayDef extends FallibleConfigValueArrayDef implements ConfigValueShortArrayDef {
     ...
     */
    FallibleConfigValueShortArrayDef(ConfigValueShortArrayDefBuilder builder) {
     ...
     */
    FallibleConfigValueShortArrayDef(ConfigValueShortArrayDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleConfigValueShortArrayDef){
            var childTree = ((FallibleConfigValueShortArrayDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleConfigValueShortArrayDef(ConfigValueShortArrayDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_array = toCopy.getArray();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleConfigValueShortArrayDef withException(ConfigValueShortArrayDef toCopy, final LoadException exception) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FallibleConfigValueShortArrayDef)) {
            return false;
        }
        FallibleConfigValueShortArrayDef other = (FallibleConfigValueShortArrayDef)o;
