...
public class DefaultJobManagerDef implements JobManagerDef {
     ...
     */
    DefaultJobManagerDef(JobManagerDefBuilder builder) {
     ...
     */
    DefaultJobManagerDef(JobManagerDef toCopy, final LoadException supplyException) {
     ...
     * @param toCopy source
     */
    public DefaultJobManagerDef(JobManagerDef toCopy) {
        m_factory = toCopy.getFactory();
        m_settings = toCopy.getSettings();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultJobManagerDef withException(JobManagerDef toCopy, final LoadException exception) {
     ...
     * returns the settings as DefaultConfigMapDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    ...
    public boolean equals(final Object o) {
        ...
        DefaultJobManagerDef other = (DefaultJobManagerDef)o;
