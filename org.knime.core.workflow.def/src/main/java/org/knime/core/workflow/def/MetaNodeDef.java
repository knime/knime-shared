...
public interface MetaNodeDef extends BaseNodeDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link MetaNodeDef#getCustomDescription} 
          */
         CUSTOM_DESCRIPTION,
         /** 
          * The type of this data attribute is {@link NodeAnnotationDef}.
          * Is is returned by {@link MetaNodeDef#getAnnotation} 
          */
         ANNOTATION,
         /** 
          ...
          * Is is returned by {@link MetaNodeDef#getJobManager} 
          */
         JOB_MANAGER,
         /** 
          ...
          * Is is returned by {@link MetaNodeDef#getInPorts} 
          */
         IN_PORTS,
         /**  
          ...
          *
          * The type of this data attribute is java.util.List&lt;PortDef&gt;.
          * Is is returned by {@link MetaNodeDef#getOutPorts} 
          */
         OUT_PORTS,
         /** 
          * The type of this data attribute is {@link CipherDef}.
          * Is is returned by {@link MetaNodeDef#getCipher} 
          */
         CIPHER,
         /** 
