...
public class FalliblePortTypeDef implements PortTypeDef {
     ...
     */
    FalliblePortTypeDef(PortTypeDefBuilder builder) {
     ...
     */
    FalliblePortTypeDef(PortTypeDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FalliblePortTypeDef){
            var childTree = ((FalliblePortTypeDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FalliblePortTypeDef(PortTypeDef toCopy) {
        m_portObjectClass = toCopy.getPortObjectClass();
        m_portObjectSpecClass = toCopy.getPortObjectSpecClass();
        m_color = toCopy.getColor();
        m_hidden = toCopy.isHidden();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FalliblePortTypeDef withException(PortTypeDef toCopy, final LoadException exception) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FalliblePortTypeDef)) {
            return false;
        }
        FalliblePortTypeDef other = (FalliblePortTypeDef)o;
