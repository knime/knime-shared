...
import org.knime.core.workflow.def.impl.FallibleAuthorInformationDef;
...
/**
 * AuthorInformationDef
 *
 * @author Martin Horn, KNIME GmbH, Konstanz, Germany
 * @author Carl Witt, KNIME AG, Zurich, Switzerland
 * @author Dionysios Stolis, KNIME GmbH, Berlin, Germany
 */
@JsonDeserialize(as = FallibleAuthorInformationDef.class)
...
public interface AuthorInformationDef {
    ...
    public enum Attribute implements DefAttribute {
         ...
         /** 
          * The type of this data attribute is {@link String}.
          * Is is returned by {@link AuthorInformationDef#getLastEditedBy} 
          */
         LAST_EDITED_BY,
         /** 
          * The type of this data attribute is {@link OffsetDateTime}.
          * Is is returned by {@link AuthorInformationDef#getLastEditedWhen} 
          */
         LAST_EDITED_WHEN,
;
    }
