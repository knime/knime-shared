...
public class FallibleBaseNodeDef implements BaseNodeDef {
     ...
     * @param toCopy source
     */
    public FallibleBaseNodeDef(BaseNodeDef toCopy) {
        m_id = toCopy.getId();
     ...
     */
    static FallibleBaseNodeDef withException(BaseNodeDef toCopy, final LoadException exception) {
        Objects.requireNonNull(exception);
        if (toCopy instanceof MetaNodeDef) {
            toCopy = Objects.requireNonNullElse(toCopy, new MetaNodeDefBuilder().build());
            return new FallibleMetaNodeDef((MetaNodeDef)toCopy, exception);
        }
        if (toCopy instanceof NativeNodeDef) {
            toCopy = Objects.requireNonNullElse(toCopy, new NativeNodeDefBuilder().build());
            return new FallibleNativeNodeDef((NativeNodeDef)toCopy, exception);
        }
        if (toCopy instanceof ComponentDef) {
            toCopy = Objects.requireNonNullElse(toCopy, new ComponentDefBuilder().build());
            return new FallibleComponentDef((ComponentDef)toCopy, exception);
        }
