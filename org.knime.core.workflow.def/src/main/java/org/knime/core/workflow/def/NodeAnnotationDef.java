 ...
 */
@JsonDeserialize(as = FallibleNodeAnnotationDef.class)
...
public interface NodeAnnotationDef {
    ...
    public enum Attribute implements DefAttribute {
         ...
         ANNOTATION_DEFAULT,
         /** 
          * The type of this data attribute is {@link AnnotationDataDef}.
          * Is is returned by {@link NodeAnnotationDef#getData} 
          */
         DATA,
;
    }
