...
import org.knime.core.workflow.def.impl.FallibleJobManagerDef;
 ...
 */
@JsonDeserialize(as = FallibleJobManagerDef.class)
...
public interface JobManagerDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link JobManagerDef#getSettings} 
          */
         SETTINGS,
;
    }
