...
/**
 * FallibleConfigValueIntArrayDef
 *
...
public class FallibleConfigValueIntArrayDef extends FallibleConfigValueArrayDef implements ConfigValueIntArrayDef {

    /** this either points to a LoadException (which implements LoadExceptionTree<Void>) or to
     * a LoadExceptionTree<ConfigValueIntArrayDef.Attribute> instance. */
    ...
    /**
     * Builder constructor. Only for use in {@link ConfigValueIntArrayDefBuilder}.
     * @param builder source
     */
    FallibleConfigValueIntArrayDef(ConfigValueIntArrayDefBuilder builder) {
     ...
     * Only for use in {@link ConfigValueIntArrayDefBuilder}.
     ...
     */
    FallibleConfigValueIntArrayDef(ConfigValueIntArrayDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleConfigValueIntArrayDef){
            var childTree = ((FallibleConfigValueIntArrayDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleConfigValueIntArrayDef(ConfigValueIntArrayDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_array = toCopy.getArray();
    ...
    // -----------------------------------------------------------------------------------------------------------------
    // Factory method to attach a LoadException to an existing ConfigValueIntArray
    // -----------------------------------------------------------------------------------------------------------------
    /**
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleConfigValueIntArrayDef withException(ConfigValueIntArrayDef toCopy, final LoadException exception) {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueIntArrayDef.Attribute attribute){
        return m_exceptionTree.flatMap(t -> {
            if(t instanceof LoadException) return Optional.empty();
            // if the tree is not a leaf, it is typed to ConfigValueIntArrayDef.Attribute
            return ((LoadExceptionTree<ConfigValueIntArrayDef.Attribute>)t).getExceptionTree(attribute);
        });
    }
    ...
    public Optional<LoadException> getConfigTypeSupplyException(){
    	return getLoadExceptionTree(ConfigValueIntArrayDef.Attribute.CONFIG_TYPE).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getArraySupplyException(){
    	return getLoadExceptionTree(ConfigValueIntArrayDef.Attribute.ARRAY).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadExceptionTree<Integer>> getArrayExceptionTree(){
    	return getLoadExceptionTree(ConfigValueIntArrayDef.Attribute.ARRAY).map(les -> (LoadExceptionTree<Integer>)les);
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FallibleConfigValueIntArrayDef)) {
            return false;
        }
        FallibleConfigValueIntArrayDef other = (FallibleConfigValueIntArrayDef)o;
