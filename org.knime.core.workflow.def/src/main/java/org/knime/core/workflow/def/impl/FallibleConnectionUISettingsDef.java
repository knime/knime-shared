...
/**
 * FallibleConnectionUISettingsDef
 *
...
public class FallibleConnectionUISettingsDef implements ConnectionUISettingsDef {
     ...
     */
    FallibleConnectionUISettingsDef(ConnectionUISettingsDefBuilder builder) {
     ...
     */
    FallibleConnectionUISettingsDef(ConnectionUISettingsDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleConnectionUISettingsDef){
            var childTree = ((FallibleConnectionUISettingsDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleConnectionUISettingsDef(ConnectionUISettingsDef toCopy) {
        m_bendPoints = toCopy.getBendPoints();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleConnectionUISettingsDef withException(ConnectionUISettingsDef toCopy, final LoadException exception) {
