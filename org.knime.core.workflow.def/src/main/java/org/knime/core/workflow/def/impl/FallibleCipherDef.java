...
public class FallibleCipherDef implements CipherDef {
     ...
     */
    FallibleCipherDef(CipherDefBuilder builder) {
     ...
     */
    FallibleCipherDef(CipherDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleCipherDef){
            var childTree = ((FallibleCipherDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleCipherDef(CipherDef toCopy) {
        m_passwordDigest = toCopy.getPasswordDigest();
        m_encryptionKey = toCopy.getEncryptionKey();
        m_passwordHint = toCopy.getPasswordHint();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleCipherDef withException(CipherDef toCopy, final LoadException exception) {
