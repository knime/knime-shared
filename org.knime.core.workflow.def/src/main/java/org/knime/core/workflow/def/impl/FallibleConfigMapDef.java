...
public class FallibleConfigMapDef extends FallibleConfigDef implements ConfigMapDef {
     ...
     */
    FallibleConfigMapDef(ConfigMapDefBuilder builder) {
     ...
     */
    FallibleConfigMapDef(ConfigMapDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleConfigMapDef){
            var childTree = ((FallibleConfigMapDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleConfigMapDef(ConfigMapDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_key = toCopy.getKey();
        m_children = toCopy.getChildren();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleConfigMapDef withException(ConfigMapDef toCopy, final LoadException exception) {
