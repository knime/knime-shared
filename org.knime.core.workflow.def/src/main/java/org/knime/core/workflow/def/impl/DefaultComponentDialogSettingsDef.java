...
public class DefaultComponentDialogSettingsDef implements ComponentDialogSettingsDef {
     ...
     */
    DefaultComponentDialogSettingsDef(ComponentDialogSettingsDefBuilder builder) {
     ...
     */
    DefaultComponentDialogSettingsDef(ComponentDialogSettingsDef toCopy, final LoadException supplyException) {
     ...
     * @param toCopy source
     */
    public DefaultComponentDialogSettingsDef(ComponentDialogSettingsDef toCopy) {
        m_layoutJSON = toCopy.getLayoutJSON();
        m_configurationLayoutJSON = toCopy.getConfigurationLayoutJSON();
        m_hideInWizard = toCopy.isHideInWizard();
        m_cssStyles = toCopy.getCssStyles();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultComponentDialogSettingsDef withException(ComponentDialogSettingsDef toCopy, final LoadException exception) {
    ...
    public boolean equals(final Object o) {
        ...
        DefaultComponentDialogSettingsDef other = (DefaultComponentDialogSettingsDef)o;
