...
public class ConfigValueIntDefBuilder {
     ...
     */
    Map<ConfigValueIntDef.Attribute, LoadExceptionTree<?>> m_exceptionalChildren = new java.util.EnumMap<>(ConfigValueIntDef.Attribute.class);
     ...
     */
    public ConfigValueIntDefBuilder() {
    }

    /**
     * Create a new builder from an existing instance.
     */
    public ConfigValueIntDefBuilder(final ConfigValueIntDef toCopy) {
     ...
     * {@code hasExceptions(ConfigValueIntDef.Attribute.CONFIG_TYPE)} will return true and and
     * {@code getExceptionalChildren().get(ConfigValueIntDef.Attribute.CONFIG_TYPE)} will return the exception.
     * 
     * @param configType see {@link ConfigValueIntDef#getConfigType}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setConfigType(String)
     */
    public ConfigValueIntDefBuilder setConfigType(final FallibleSupplier<String> configType, String defaultValue) {
        java.util.Objects.requireNonNull(configType, () -> "No supplier for configType provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(ConfigValueIntDef.Attribute.CONFIG_TYPE);
        try {
     ...
     * Sets the field using a supplier that may throw an exception. If an exception is thrown, it is recorded and can
     * be accessed through {@link LoadExceptionTree} interface of the instance build by this builder.
     * {@code hasExceptions(ConfigValueIntDef.Attribute.VALUE)} will return true and and
     * {@code getExceptionalChildren().get(ConfigValueIntDef.Attribute.VALUE)} will return the exception.
     * 
     * @param value see {@link ConfigValueIntDef#getValue}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setValue(Integer)
     */
    public ConfigValueIntDefBuilder setValue(final FallibleSupplier<Integer> value, Integer defaultValue) {
    ...
    // -----------------------------------------------------------------------------------------------------------------
    /**
	 * @return the {@link ConfigValueIntDef} created from the data passed to the setters. Implements 
     *      {@link LoadExceptionTree} to provide access to any load exceptions that have occurred during evaluation
     *      of the suppliers passed to the setters.
	 */
    public FallibleConfigValueIntDef build() {
        ...
        return new FallibleConfigValueIntDef(this);
    }    
