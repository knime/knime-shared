...
public class ConfigValueByteArrayDefBuilder {
     ...
     */
    Map<ConfigValueByteArrayDef.Attribute, LoadExceptionTree<?>> m_exceptionalChildren = new java.util.EnumMap<>(ConfigValueByteArrayDef.Attribute.class);
     ...
     */
    public ConfigValueByteArrayDefBuilder() {
    }
     ...
     * {@code hasExceptions(ConfigValueByteArrayDef.Attribute.CONFIG_TYPE)} will return true and and
     * {@code getExceptionalChildren().get(ConfigValueByteArrayDef.Attribute.CONFIG_TYPE)} will return the exception.
     * 
     * @param configType see {@link ConfigValueByteArrayDef#getConfigType}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setConfigType(String)
     */
    public ConfigValueByteArrayDefBuilder setConfigType(final FallibleSupplier<String> configType, String defaultValue) {
     ...
     * @see #setArray(byte[])
     */
    public ConfigValueByteArrayDefBuilder setArray(final FallibleSupplier<byte[]> array, byte[] defaultValue) {
    ...
    // -----------------------------------------------------------------------------------------------------------------
    /**
	 * @return the {@link ConfigValueByteArrayDef} created from the data passed to the setters. Implements 
     *      {@link LoadExceptionTree} to provide access to any load exceptions that have occurred during evaluation
     *      of the suppliers passed to the setters.
	 */
    public FallibleConfigValueByteArrayDef build() {
        ...
        return new FallibleConfigValueByteArrayDef(this);
    }    
