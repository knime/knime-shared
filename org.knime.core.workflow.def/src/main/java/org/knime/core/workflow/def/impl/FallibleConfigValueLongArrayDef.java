...
/**
 * FallibleConfigValueLongArrayDef
 *
...
public class FallibleConfigValueLongArrayDef extends FallibleConfigValueArrayDef implements ConfigValueLongArrayDef {

    /** this either points to a LoadException (which implements LoadExceptionTree<Void>) or to
     * a LoadExceptionTree<ConfigValueLongArrayDef.Attribute> instance. */
    final private Optional<LoadExceptionTree<?>> m_exceptionTree;

    @JsonProperty("array")
    protected java.util.List<Long> m_array;
    ...
    /**
     * Builder constructor. Only for use in {@link ConfigValueLongArrayDefBuilder}.
     * @param builder source
     */
    FallibleConfigValueLongArrayDef(ConfigValueLongArrayDefBuilder builder) {
     ...
     * Only for use in {@link ConfigValueLongArrayDefBuilder}.
     ...
     */
    FallibleConfigValueLongArrayDef(ConfigValueLongArrayDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleConfigValueLongArrayDef){
            var childTree = ((FallibleConfigValueLongArrayDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleConfigValueLongArrayDef(ConfigValueLongArrayDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_array = toCopy.getArray();
    ...
    // -----------------------------------------------------------------------------------------------------------------
    // Factory method to attach a LoadException to an existing ConfigValueLongArray
    // -----------------------------------------------------------------------------------------------------------------
    /**
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleConfigValueLongArrayDef withException(ConfigValueLongArrayDef toCopy, final LoadException exception) {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueLongArrayDef.Attribute attribute){
        return m_exceptionTree.flatMap(t -> {
            if(t instanceof LoadException) return Optional.empty();
            // if the tree is not a leaf, it is typed to ConfigValueLongArrayDef.Attribute
            return ((LoadExceptionTree<ConfigValueLongArrayDef.Attribute>)t).getExceptionTree(attribute);
        });
    }
    ...
    @Override
    public java.util.List<Long> getArray() {
        return m_array;
    }
    ...
    public Optional<LoadException> getConfigTypeSupplyException(){
    	return getLoadExceptionTree(ConfigValueLongArrayDef.Attribute.CONFIG_TYPE).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getArraySupplyException(){
    	return getLoadExceptionTree(ConfigValueLongArrayDef.Attribute.ARRAY).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadExceptionTree<Integer>> getArrayExceptionTree(){
    	return getLoadExceptionTree(ConfigValueLongArrayDef.Attribute.ARRAY).map(les -> (LoadExceptionTree<Integer>)les);
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FallibleConfigValueLongArrayDef)) {
            return false;
        }
        FallibleConfigValueLongArrayDef other = (FallibleConfigValueLongArrayDef)o;
