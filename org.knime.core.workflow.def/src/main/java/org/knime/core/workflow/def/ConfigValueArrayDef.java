 ...
 */
@JsonDeserialize(as = FallibleConfigValueArrayDef.class)
...
public interface ConfigValueArrayDef extends ConfigDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link ConfigValueArrayDef#getConfigType} 
          */
         CONFIG_TYPE,
;
    }
