 ...
 */
@JsonDeserialize(as = FallibleConnectionDef.class)
...
public interface ConnectionDef {
    ...
    public enum Attribute implements DefAttribute {
         ...
         DELETABLE,
         /** 
          * The type of this data attribute is {@link ConnectionUISettingsDef}.
          * Is is returned by {@link ConnectionDef#getUiSettings} 
          */
         UI_SETTINGS,
;
    }
