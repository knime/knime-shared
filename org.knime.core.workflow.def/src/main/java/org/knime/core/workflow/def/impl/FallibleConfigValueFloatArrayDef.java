...
/**
 * FallibleConfigValueFloatArrayDef
 *
...
public class FallibleConfigValueFloatArrayDef extends FallibleConfigValueArrayDef implements ConfigValueFloatArrayDef {

    /** this either points to a LoadException (which implements LoadExceptionTree<Void>) or to
     * a LoadExceptionTree<ConfigValueFloatArrayDef.Attribute> instance. */
    final private Optional<LoadExceptionTree<?>> m_exceptionTree;

    @JsonProperty("array")
    protected java.util.List<Float> m_array;
    ...
    /**
     * Builder constructor. Only for use in {@link ConfigValueFloatArrayDefBuilder}.
     * @param builder source
     */
    FallibleConfigValueFloatArrayDef(ConfigValueFloatArrayDefBuilder builder) {
     ...
     * Only for use in {@link ConfigValueFloatArrayDefBuilder}.
     ...
     */
    FallibleConfigValueFloatArrayDef(ConfigValueFloatArrayDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleConfigValueFloatArrayDef){
            var childTree = ((FallibleConfigValueFloatArrayDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleConfigValueFloatArrayDef(ConfigValueFloatArrayDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_array = toCopy.getArray();
    ...
    // -----------------------------------------------------------------------------------------------------------------
    // Factory method to attach a LoadException to an existing ConfigValueFloatArray
    // -----------------------------------------------------------------------------------------------------------------
    /**
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleConfigValueFloatArrayDef withException(ConfigValueFloatArrayDef toCopy, final LoadException exception) {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueFloatArrayDef.Attribute attribute){
        return m_exceptionTree.flatMap(t -> {
            if(t instanceof LoadException) return Optional.empty();
            // if the tree is not a leaf, it is typed to ConfigValueFloatArrayDef.Attribute
            return ((LoadExceptionTree<ConfigValueFloatArrayDef.Attribute>)t).getExceptionTree(attribute);
        });
    }
    ...
    @Override
    public java.util.List<Float> getArray() {
        return m_array;
    }
    ...
    public Optional<LoadException> getConfigTypeSupplyException(){
    	return getLoadExceptionTree(ConfigValueFloatArrayDef.Attribute.CONFIG_TYPE).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getArraySupplyException(){
    	return getLoadExceptionTree(ConfigValueFloatArrayDef.Attribute.ARRAY).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadExceptionTree<Integer>> getArrayExceptionTree(){
    	return getLoadExceptionTree(ConfigValueFloatArrayDef.Attribute.ARRAY).map(les -> (LoadExceptionTree<Integer>)les);
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FallibleConfigValueFloatArrayDef)) {
            return false;
        }
        FallibleConfigValueFloatArrayDef other = (FallibleConfigValueFloatArrayDef)o;
