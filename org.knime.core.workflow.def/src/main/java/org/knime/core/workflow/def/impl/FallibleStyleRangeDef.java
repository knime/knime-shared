...
public class FallibleStyleRangeDef implements StyleRangeDef {
     ...
     */
    FallibleStyleRangeDef(StyleRangeDefBuilder builder) {
     ...
     */
    FallibleStyleRangeDef(StyleRangeDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleStyleRangeDef){
            var childTree = ((FallibleStyleRangeDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleStyleRangeDef(StyleRangeDef toCopy) {
        m_fontSize = toCopy.getFontSize();
        m_color = toCopy.getColor();
        m_start = toCopy.getStart();
        m_fontName = toCopy.getFontName();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleStyleRangeDef withException(StyleRangeDef toCopy, final LoadException exception) {
