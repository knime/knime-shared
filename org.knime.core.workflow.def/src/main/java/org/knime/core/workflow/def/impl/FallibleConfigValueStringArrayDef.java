...
/**
 * FallibleConfigValueStringArrayDef
 *
...
public class FallibleConfigValueStringArrayDef extends FallibleConfigValueArrayDef implements ConfigValueStringArrayDef {

    /** this either points to a LoadException (which implements LoadExceptionTree<Void>) or to
     * a LoadExceptionTree<ConfigValueStringArrayDef.Attribute> instance. */
    final private Optional<LoadExceptionTree<?>> m_exceptionTree;

    @JsonProperty("array")
    protected java.util.List<String> m_array;
    ...
    /**
     * Builder constructor. Only for use in {@link ConfigValueStringArrayDefBuilder}.
     * @param builder source
     */
    FallibleConfigValueStringArrayDef(ConfigValueStringArrayDefBuilder builder) {
     ...
     * Only for use in {@link ConfigValueStringArrayDefBuilder}.
     ...
     */
    FallibleConfigValueStringArrayDef(ConfigValueStringArrayDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleConfigValueStringArrayDef){
            var childTree = ((FallibleConfigValueStringArrayDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleConfigValueStringArrayDef(ConfigValueStringArrayDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_array = toCopy.getArray();
    ...
    // -----------------------------------------------------------------------------------------------------------------
    // Factory method to attach a LoadException to an existing ConfigValueStringArray
    // -----------------------------------------------------------------------------------------------------------------
    /**
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleConfigValueStringArrayDef withException(ConfigValueStringArrayDef toCopy, final LoadException exception) {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueStringArrayDef.Attribute attribute){
        return m_exceptionTree.flatMap(t -> {
            if(t instanceof LoadException) return Optional.empty();
            // if the tree is not a leaf, it is typed to ConfigValueStringArrayDef.Attribute
            return ((LoadExceptionTree<ConfigValueStringArrayDef.Attribute>)t).getExceptionTree(attribute);
        });
    }
    ...
    public Optional<LoadException> getConfigTypeSupplyException(){
    	return getLoadExceptionTree(ConfigValueStringArrayDef.Attribute.CONFIG_TYPE).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getArraySupplyException(){
    	return getLoadExceptionTree(ConfigValueStringArrayDef.Attribute.ARRAY).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadExceptionTree<Integer>> getArrayExceptionTree(){
    	return getLoadExceptionTree(ConfigValueStringArrayDef.Attribute.ARRAY).map(les -> (LoadExceptionTree<Integer>)les);
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FallibleConfigValueStringArrayDef)) {
            return false;
        }
        FallibleConfigValueStringArrayDef other = (FallibleConfigValueStringArrayDef)o;
