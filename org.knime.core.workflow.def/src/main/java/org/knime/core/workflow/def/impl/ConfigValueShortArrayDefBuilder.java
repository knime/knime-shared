...
import org.knime.core.workflow.def.impl.ConfigValueArrayDefBuilder;
...
/**
 * ConfigValueShortArrayDefBuilder
...
public class ConfigValueShortArrayDefBuilder {
     ...
     */
    Map<ConfigValueShortArrayDef.Attribute, LoadExceptionTree<?>> m_exceptionalChildren = new java.util.EnumMap<>(ConfigValueShortArrayDef.Attribute.class);
     ...
     */
    java.util.List<Integer> m_array = new java.util.ArrayList<>();
    /** Temporarily holds onto elements set as a whole with setArray these are added to m_array in build */
    private java.util.List<Integer> m_arrayBulkElements = new java.util.ArrayList<>();
     ...
     */
    public ConfigValueShortArrayDefBuilder() {
    }

    /**
     * Create a new builder from an existing instance.
     */
    public ConfigValueShortArrayDefBuilder(final ConfigValueShortArrayDef toCopy) {
     ...
     */ 
    public ConfigValueShortArrayDefBuilder setConfigType(final String configType) {
     ...
     * {@code hasExceptions(ConfigValueShortArrayDef.Attribute.CONFIG_TYPE)} will return true and and
     * {@code getExceptionalChildren().get(ConfigValueShortArrayDef.Attribute.CONFIG_TYPE)} will return the exception.
     * 
     * @param configType see {@link ConfigValueShortArrayDef#getConfigType}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setConfigType(String)
     */
    public ConfigValueShortArrayDefBuilder setConfigType(final FallibleSupplier<String> configType, String defaultValue) {
        java.util.Objects.requireNonNull(configType, () -> "No supplier for configType provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(ConfigValueShortArrayDef.Attribute.CONFIG_TYPE);
        try {
            ...
            m_exceptionalChildren.put(ConfigValueShortArrayDef.Attribute.CONFIG_TYPE, supplyException);
	    }   
        return this;
    }
    // -----------------------------------------------------------------------------------------------------------------
     ...
     */
    public ConfigValueShortArrayDefBuilder setArray(final java.util.List<Integer> array) {
        setArray(() -> array);
        return this;
    }
     ...
     * {@code hasExceptions(ConfigValueShortArrayDef.Attribute.ARRAY)} will return true and and
     * {@code getExceptionalChildren().get(ConfigValueShortArrayDef.Attribute.ARRAY)} will return the exception.
     * 
     * @param array see {@link ConfigValueShortArrayDef#getArray}
     * 
     * @return this builder for fluent API.
     * @see #setArray(java.util.List<Integer>)
     */
    public ConfigValueShortArrayDefBuilder setArray(final FallibleSupplier<java.util.List<Integer>> array) {
        java.util.Objects.requireNonNull(array, () -> "No supplier for array provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(ConfigValueShortArrayDef.Attribute.ARRAY);
        try {
     ...
     * @return this builder for fluent API
     */
    public ConfigValueShortArrayDefBuilder addToArray(Integer value){
    	addToArray(() -> value, /* default value will not be used */ value);
        return this;
    }
    
    /**
     * Adds the return value of the fallible supplier to the list returned by {@link ConfigValueShortArrayDef#getArray}. If the 
     ...
     * @return this builder for fluent API.
     */
    public ConfigValueShortArrayDefBuilder addToArray(FallibleSupplier<Integer> value, Integer defaultValue) {
        Integer toAdd = null;
        try {
            toAdd = value.get();
        } catch (Exception e) {
    ...
    // -----------------------------------------------------------------------------------------------------------------
    /**
	 * @return the {@link ConfigValueShortArrayDef} created from the data passed to the setters. Implements 
     *      {@link LoadExceptionTree} to provide access to any load exceptions that have occurred during evaluation
     *      of the suppliers passed to the setters.
	 */
    public FallibleConfigValueShortArrayDef build() {
        ...
        var arrayLoadExceptionTree = org.knime.core.util.workflow.def.SimpleLoadExceptionTree
            ...
            m_exceptionalChildren.put(ConfigValueShortArrayDef.Attribute.ARRAY, arrayLoadExceptionTree);
        }
        
        return new FallibleConfigValueShortArrayDef(this);
    }    
