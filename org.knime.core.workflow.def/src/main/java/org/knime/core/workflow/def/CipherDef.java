...
import org.knime.core.workflow.def.impl.FallibleCipherDef;
 ...
 */
@JsonDeserialize(as = FallibleCipherDef.class)
...
public interface CipherDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          *
          * The type of this data attribute is {@link String}.
          * Is is returned by {@link CipherDef#getPasswordHint} 
          */
         PASSWORD_HINT,
;
    }
