...
public class FallibleConfigValueDef extends FallibleConfigDef implements ConfigValueDef {
     ...
     * @param toCopy source
     */
    public FallibleConfigValueDef(ConfigValueDef toCopy) {
     ...
     */
    static FallibleConfigValueDef withException(ConfigValueDef toCopy, final LoadException exception) {
