...
public class FallibleAuthorInformationDef implements AuthorInformationDef {
     ...
     */
    FallibleAuthorInformationDef(AuthorInformationDefBuilder builder) {
     ...
     */
    FallibleAuthorInformationDef(AuthorInformationDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleAuthorInformationDef){
            var childTree = ((FallibleAuthorInformationDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleAuthorInformationDef(AuthorInformationDef toCopy) {
        m_authoredBy = toCopy.getAuthoredBy();
        m_authoredWhen = toCopy.getAuthoredWhen();
        m_lastEditedBy = toCopy.getLastEditedBy();
        m_lastEditedWhen = toCopy.getLastEditedWhen();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleAuthorInformationDef withException(AuthorInformationDef toCopy, final LoadException exception) {
