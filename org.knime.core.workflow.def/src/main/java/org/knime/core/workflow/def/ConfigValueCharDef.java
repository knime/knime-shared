 ...
 */
@JsonDeserialize(as = FallibleConfigValueCharDef.class)
...
public interface ConfigValueCharDef extends ConfigValueDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link ConfigValueCharDef#getConfigType} 
          */
         CONFIG_TYPE,
         /** 
          * The type of this data attribute is {@link Integer}.
          * Is is returned by {@link ConfigValueCharDef#getValue} 
          */
         VALUE,
;
    }
