...
public class FallibleNodeLocksDef implements NodeLocksDef {
     ...
     */
    FallibleNodeLocksDef(NodeLocksDefBuilder builder) {
     ...
     */
    FallibleNodeLocksDef(NodeLocksDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleNodeLocksDef){
            var childTree = ((FallibleNodeLocksDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleNodeLocksDef(NodeLocksDef toCopy) {
        m_hasDeleteLock = toCopy.hasDeleteLock();
        m_hasResetLock = toCopy.hasResetLock();
        m_hasConfigureLock = toCopy.hasConfigureLock();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleNodeLocksDef withException(NodeLocksDef toCopy, final LoadException exception) {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(NodeLocksDef.Attribute attribute){
        return m_exceptionTree.flatMap(t -> {
            ...
            return ((LoadExceptionTree<NodeLocksDef.Attribute>)t).getExceptionTree(attribute);
        });
    }
