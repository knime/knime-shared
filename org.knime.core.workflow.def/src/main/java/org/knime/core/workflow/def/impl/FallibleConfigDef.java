...
public class FallibleConfigDef implements ConfigDef {
     ...
     * @param toCopy source
     */
    public FallibleConfigDef(ConfigDef toCopy) {
     ...
     */
    static FallibleConfigDef withException(ConfigDef toCopy, final LoadException exception) {
        ...
        if (toCopy instanceof ConfigValueFloatArrayDef) {
            ...
            return new FallibleConfigValueFloatArrayDef((ConfigValueFloatArrayDef)toCopy, exception);
        }
        if (toCopy instanceof ConfigValueStringArrayDef) {
            ...
            return new FallibleConfigValueStringArrayDef((ConfigValueStringArrayDef)toCopy, exception);
        }
        ...
        if (toCopy instanceof ConfigValueBooleanArrayDef) {
            ...
            return new FallibleConfigValueBooleanArrayDef((ConfigValueBooleanArrayDef)toCopy, exception);
        }
        if (toCopy instanceof ConfigValueLongArrayDef) {
            ...
            return new FallibleConfigValueLongArrayDef((ConfigValueLongArrayDef)toCopy, exception);
        }
        if (toCopy instanceof ConfigValueShortArrayDef) {
            ...
            return new FallibleConfigValueShortArrayDef((ConfigValueShortArrayDef)toCopy, exception);
        }
        if (toCopy instanceof ConfigValueCharArrayDef) {
            ...
            return new FallibleConfigValueCharArrayDef((ConfigValueCharArrayDef)toCopy, exception);
        }
        ...
        if (toCopy instanceof ConfigValueBooleanDef) {
            ...
            return new FallibleConfigValueBooleanDef((ConfigValueBooleanDef)toCopy, exception);
        }
        if (toCopy instanceof ConfigValueFloatDef) {
            toCopy = Objects.requireNonNullElse(toCopy, new ConfigValueFloatDefBuilder().build());
            return new FallibleConfigValueFloatDef((ConfigValueFloatDef)toCopy, exception);
        }
