...
public class FallibleFilestoreDef implements FilestoreDef {
     ...
     */
    FallibleFilestoreDef(FilestoreDefBuilder builder) {
     ...
     */
    FallibleFilestoreDef(FilestoreDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof FallibleFilestoreDef){
            var childTree = ((FallibleFilestoreDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public FallibleFilestoreDef(FilestoreDef toCopy) {
        m_id = toCopy.getId();
        m_location = toCopy.getLocation();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static FallibleFilestoreDef withException(FilestoreDef toCopy, final LoadException exception) {
