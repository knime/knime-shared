...
class ObjectMapperUtilTest {
    ...
    /**
     * Make sure that special characters such as emoji or non-latin characters survive a Jackson roundtrip.
     * @throws JsonProcessingException
     */
    @Test
    void testSpecialCharacters() throws JsonProcessingException {
        String annotationText = "ィキペディア 🙈";

        AnnotationDataDef annotationDef = new AnnotationDataDefBuilder()//
                .setText(annotationText)//
                .build();

        WorkflowDef wf = new WorkflowDefBuilder()//
                .putToAnnotations("0", annotationDef)//
                .build();
        ...
        assertThat(parsedBack.getAnnotations().get().get("0").getText().get())
