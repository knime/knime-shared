 ...
 */
public class GatewayJSClientCodegen extends DefaultCodegen implements CodegenConfig {
    @SuppressWarnings("hiding")
    private static final Logger LOGGER = LoggerFactory.getLogger(GatewayJSClientCodegen.class);
     ...
     */
    private String createPath(final String... segments) {
    ...
    public void setUsePromises(final boolean usePromises) {
        this.usePromises = usePromises;
    }

    public void setUseES6(final boolean useES6) {
        this.useES6 = useES6;
        if (useES6) {
    ...
    public void setEmitModelMethods(final boolean emitModelMethods) {
        this.emitModelMethods = emitModelMethods;
    }

    public void setEmitJSDoc(final boolean emitJSDoc) {
    ...
    @Override
    public String toDefaultValueWithParam(final String name, final Property p) {
     ...
     */
    public String normalizeType(final String type) {
    ...
    public CodegenModel fromModel(final String name, final Model model, final Map<String, Model> allDefinitions) {
        ...
        if (allDefinitions != null && codegenModel != null && codegenModel.parent != null && codegenModel.hasEnums) {
            ...
            codegenModel = GatewayJSClientCodegen.reconcileInlineEnums(codegenModel, parentCodegenModel);
        }
    ...
    private String trimBrackets(final String s) {
        if (s != null) {
    ...
    private String getModelledType(final String dataType) {
        return "module:" + (StringUtils.isEmpty(invokerPackage) ? "" : (invokerPackage + "/"))
            + (StringUtils.isEmpty(modelPackage) ? "" : (modelPackage + "/")) + dataType;
    }

    private String getJSDocType(final CodegenModel cm, final CodegenProperty cp) {
    ...
    private boolean isModelledType(final CodegenProperty cp) {
    ...
    private String getJSDocType(final CodegenParameter cp) {
    ...
    private boolean isModelledType(final CodegenParameter cp) {
        // N.B. enums count as modelled types, file is not modelled (SuperAgent uses some 3rd party library).
        return cp.isEnum || !languageSpecificPrimitives.contains(cp.baseType == null ? cp.dataType : cp.baseType);
    }

    private String getJSDocType(final CodegenOperation co) {
    ...
    private boolean isModelledType(final CodegenOperation co) {
