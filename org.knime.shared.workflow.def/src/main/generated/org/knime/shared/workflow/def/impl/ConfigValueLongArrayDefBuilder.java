...
/**
 * ConfigValueLongArrayDefBuilder
 * @author Martin Horn, KNIME GmbH, Konstanz, Germany
 * @author Carl Witt, KNIME AG, Zurich, Switzerland
 * @author Dionysios Stolis, KNIME GmbH, Berlin, Germany
 */
// @javax.annotation.Generated(value = {"com.knime.gateway.codegen.CoreCodegen", "src-gen/api/core/configs/org.knime.shared.workflow.def.impl.def-builder-config.json"})
public class ConfigValueLongArrayDefBuilder {
     ...
     */
    public ConfigValueLongArrayDefBuilder strict(){
        m__failFast = true;
        return this;
    }
     ...
     */
    Map<ConfigValueLongArrayDef.Attribute, LoadExceptionTree<?>> m_exceptionalChildren = new java.util.EnumMap<>(ConfigValueLongArrayDef.Attribute.class);
     ...
     */
    Optional<java.util.List<Long>> m_array = Optional.of(java.util.List.of());
    /** 
     ...
     */
    Optional<java.util.List<Long>> m_arrayIndividualElements = Optional.empty();
    /** 
     ...
     */
    private Optional<java.util.List<Long>> m_arrayBulkElements = Optional.empty();
     ...
     * @return this builder for fluent API.
     */ 
    public ConfigValueLongArrayDefBuilder setConfigType(final String configType) {
     ...
     * {@code hasExceptions(ConfigValueLongArrayDef.Attribute.CONFIG_TYPE)} will return true and and
     * {@code getExceptionalChildren().get(ConfigValueLongArrayDef.Attribute.CONFIG_TYPE)} will return the exception.
     * 
     * @param configType see {@link ConfigValueLongArrayDef#getConfigType}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setConfigType(String)
     */
    public ConfigValueLongArrayDefBuilder setConfigType(final FallibleSupplier<String> configType, String defaultValue) {
        java.util.Objects.requireNonNull(configType, () -> "No supplier for configType provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(ConfigValueLongArrayDef.Attribute.CONFIG_TYPE);
        try {
            ...
            m_exceptionalChildren.put(ConfigValueLongArrayDef.Attribute.CONFIG_TYPE, supplyException);
            if(m__failFast){
     ...
     */
    public ConfigValueLongArrayDefBuilder setArray(final java.util.List<Long> array) {
        setArray(() -> array);
        return this;
    }
     ...
     * {@code hasExceptions(ConfigValueLongArrayDef.Attribute.ARRAY)} will return true and and
     * {@code getExceptionalChildren().get(ConfigValueLongArrayDef.Attribute.ARRAY)} will return the exception.
     * 
     * @param array see {@link ConfigValueLongArrayDef#getArray}
     * 
     * @return this builder for fluent API.
     * @see #setArray(java.util.List<Long>)
     */
    public ConfigValueLongArrayDefBuilder setArray(final FallibleSupplier<java.util.List<Long>> array) {
        java.util.Objects.requireNonNull(array, () -> "No supplier for array provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(ConfigValueLongArrayDef.Attribute.ARRAY);
        try {
     ...
     * @return this builder for fluent API
     */
    public ConfigValueLongArrayDefBuilder addToArray(Long value){
    	addToArray(() -> value, /* default value will not be used */ value);
        return this;
    }
    
    /**
     * Adds the return value of the fallible supplier to the list returned by {@link ConfigValueLongArrayDef#getArray}. If the 
     ...
     * @return this builder for fluent API.
     */
    public ConfigValueLongArrayDefBuilder addToArray(FallibleSupplier<Long> value, Long defaultValue) {
    ...
    // -----------------------------------------------------------------------------------------------------------------
    /**
	 * @return the {@link ConfigValueLongArrayDef} created from the data passed to the setters. Implements 
     *      {@link LoadExceptionTree} to provide access to any load exceptions that have occurred during evaluation
     *      of the suppliers passed to the setters.
	 */
    public DefaultConfigValueLongArrayDef build() {
        ...
        var arrayLoadExceptionTree = org.knime.shared.workflow.def.SimpleLoadExceptionTree
            ...
            m_exceptionalChildren.put(ConfigValueLongArrayDef.Attribute.ARRAY, arrayLoadExceptionTree);
        }
        
        return new DefaultConfigValueLongArrayDef(this);
    }    
