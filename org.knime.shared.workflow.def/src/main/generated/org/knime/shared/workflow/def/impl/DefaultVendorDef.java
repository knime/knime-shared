...
public class DefaultVendorDef implements VendorDef, LoadExceptionTreeProvider {
     ...
     */
    DefaultVendorDef(VendorDefBuilder builder) {
     ...
     */
    DefaultVendorDef(VendorDef toCopy, final LoadException supplyException) {
     ...
     * @param toCopy source
     */
    public DefaultVendorDef(VendorDef toCopy) {
        m_name = toCopy.getName();
        m_symbolicName = toCopy.getSymbolicName();
        m_vendor = toCopy.getVendor();
        m_version = toCopy.getVersion();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultVendorDef withException(VendorDef toCopy, final LoadException exception) {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(VendorDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<VendorDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
    ...
    public boolean equals(final Object o) {
        ...
        DefaultVendorDef other = (DefaultVendorDef)o;
