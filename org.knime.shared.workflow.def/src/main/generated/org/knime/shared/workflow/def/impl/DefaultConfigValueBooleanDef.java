...
public class DefaultConfigValueBooleanDef extends DefaultConfigValueDef implements ConfigValueBooleanDef, LoadExceptionTreeProvider {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueBooleanDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<ConfigValueBooleanDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
