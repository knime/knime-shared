...
public class ConfigValueFloatArrayDefBuilder {
     ...
     */
    Map<ConfigValueFloatArrayDef.Attribute, LoadExceptionTree<?>> m_exceptionalChildren = new java.util.EnumMap<>(ConfigValueFloatArrayDef.Attribute.class);
     ...
     */
    Optional<java.util.List<Float>> m_array = Optional.of(java.util.List.of());
    /** 
     ...
     */
    Optional<java.util.List<Float>> m_arrayIndividualElements = Optional.empty();
    /** 
     ...
     */
    private Optional<java.util.List<Float>> m_arrayBulkElements = Optional.empty();
     ...
     */
    public ConfigValueFloatArrayDefBuilder() {
    }

    /**
     * Create a new builder from an existing instance.
     */
    public ConfigValueFloatArrayDefBuilder(final ConfigValueFloatArrayDef toCopy) {
     ...
     * {@code hasExceptions(ConfigValueFloatArrayDef.Attribute.CONFIG_TYPE)} will return true and and
     * {@code getExceptionalChildren().get(ConfigValueFloatArrayDef.Attribute.CONFIG_TYPE)} will return the exception.
     * 
     * @param configType see {@link ConfigValueFloatArrayDef#getConfigType}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setConfigType(String)
     */
    public ConfigValueFloatArrayDefBuilder setConfigType(final FallibleSupplier<String> configType, String defaultValue) {
        java.util.Objects.requireNonNull(configType, () -> "No supplier for configType provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(ConfigValueFloatArrayDef.Attribute.CONFIG_TYPE);
        try {
     ...
     */
    public ConfigValueFloatArrayDefBuilder setArray(final java.util.List<Float> array) {
        setArray(() -> array);
        return this;
    }
     ...
     * {@code hasExceptions(ConfigValueFloatArrayDef.Attribute.ARRAY)} will return true and and
     * {@code getExceptionalChildren().get(ConfigValueFloatArrayDef.Attribute.ARRAY)} will return the exception.
     * 
     * @param array see {@link ConfigValueFloatArrayDef#getArray}
     * 
     * @return this builder for fluent API.
     * @see #setArray(java.util.List<Float>)
     */
    public ConfigValueFloatArrayDefBuilder setArray(final FallibleSupplier<java.util.List<Float>> array) {
     ...
     * @return this builder for fluent API
     */
    public ConfigValueFloatArrayDefBuilder addToArray(Float value){
    	addToArray(() -> value, /* default value will not be used */ value);
        return this;
    }
    
    /**
     * Adds the return value of the fallible supplier to the list returned by {@link ConfigValueFloatArrayDef#getArray}. If the 
     ...
     * @return this builder for fluent API.
     */
    public ConfigValueFloatArrayDefBuilder addToArray(FallibleSupplier<Float> value, Float defaultValue) {
    ...
    // -----------------------------------------------------------------------------------------------------------------
    /**
	 * @return the {@link ConfigValueFloatArrayDef} created from the data passed to the setters. Implements 
    ...
    public DefaultConfigValueFloatArrayDef build() {
        ...
        var arrayLoadExceptionTree = org.knime.shared.workflow.def.SimpleLoadExceptionTree
            ...
            m_exceptionalChildren.put(ConfigValueFloatArrayDef.Attribute.ARRAY, arrayLoadExceptionTree);
        }
        
        return new DefaultConfigValueFloatArrayDef(this);
    }    
