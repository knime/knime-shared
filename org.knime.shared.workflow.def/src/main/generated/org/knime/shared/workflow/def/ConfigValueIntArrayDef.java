...
/**
 * ConfigValueIntArrayDef
 *
 * @author Martin Horn, KNIME GmbH, Konstanz, Germany
 * @author Carl Witt, KNIME AG, Zurich, Switzerland
 * @author Dionysios Stolis, KNIME GmbH, Berlin, Germany
 */
@JsonDeserialize(as = DefaultConfigValueIntArrayDef.class)
...
public interface ConfigValueIntArrayDef extends ConfigValueArrayDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link ConfigValueIntArrayDef#getConfigType} 
          */
         CONFIG_TYPE,
         /** 
          * The type of this data attribute is java.util.List&lt;Integer&gt;.
          * Is is returned by {@link ConfigValueIntArrayDef#getArray} 
          */
         ARRAY,
;
    }
