 ...
 */
@JsonDeserialize(as = DefaultSingleNodeDef.class)
...
public interface SingleNodeDef extends BaseNodeDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link SingleNodeDef#getId} 
          */
         ID,
         /**  
          ...
          * Is is returned by {@link SingleNodeDef#getNodeType} 
          */
         NODE_TYPE,
         /**  
          ...
          * Is is returned by {@link SingleNodeDef#getCustomDescription} 
          */
         CUSTOM_DESCRIPTION,
         /** 
          * The type of this data attribute is {@link NodeAnnotationDef}.
          * Is is returned by {@link SingleNodeDef#getAnnotation} 
          */
         ANNOTATION,
         /** 
          * The type of this data attribute is {@link BoundsDef}.
          * Is is returned by {@link SingleNodeDef#getBounds} 
          */
         BOUNDS,
         /** 
          * The type of this data attribute is {@link NodeLocksDef}.
          * Is is returned by {@link SingleNodeDef#getLocks} 
          */
         LOCKS,
         /** 
          * The type of this data attribute is {@link JobManagerDef}.
          * Is is returned by {@link SingleNodeDef#getJobManager} 
          */
         JOB_MANAGER,
         /** 
          * The type of this data attribute is {@link ConfigMapDef}.
          * Is is returned by {@link SingleNodeDef#getModelSettings} 
          */
         MODEL_SETTINGS,
         /** 
          * The type of this data attribute is {@link ConfigMapDef}.
          * Is is returned by {@link SingleNodeDef#getInternalNodeSubSettings} 
          */
         INTERNAL_NODE_SUB_SETTINGS,
         /** 
          * The type of this data attribute is {@link ConfigMapDef}.
          * Is is returned by {@link SingleNodeDef#getVariableSettings} 
          */
         VARIABLE_SETTINGS,
;
    }
