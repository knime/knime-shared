...
public class DefaultConfigValueStringDef extends DefaultConfigValueDef implements ConfigValueStringDef, LoadExceptionTreeProvider {
    ...
    @JsonProperty("value")
    protected Optional<String> m_value;
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueStringDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<ConfigValueStringDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
