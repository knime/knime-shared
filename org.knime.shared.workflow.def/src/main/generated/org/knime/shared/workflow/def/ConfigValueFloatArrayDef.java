...
/**
 * ConfigValueFloatArrayDef
 *
 * @author Martin Horn, KNIME GmbH, Konstanz, Germany
 * @author Carl Witt, KNIME AG, Zurich, Switzerland
 * @author Dionysios Stolis, KNIME GmbH, Berlin, Germany
 */
@JsonDeserialize(as = DefaultConfigValueFloatArrayDef.class)
...
public interface ConfigValueFloatArrayDef extends ConfigValueArrayDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link ConfigValueFloatArrayDef#getConfigType} 
          */
         CONFIG_TYPE,
         /** 
          * The type of this data attribute is java.util.List&lt;Float&gt;.
          * Is is returned by {@link ConfigValueFloatArrayDef#getArray} 
          */
         ARRAY,
;
    }
