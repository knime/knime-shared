...
/**
 * ConfigValueBooleanArrayDef
 *
 * @author Martin Horn, KNIME GmbH, Konstanz, Germany
 * @author Carl Witt, KNIME AG, Zurich, Switzerland
 * @author Dionysios Stolis, KNIME GmbH, Berlin, Germany
 */
@JsonDeserialize(as = DefaultConfigValueBooleanArrayDef.class)
...
public interface ConfigValueBooleanArrayDef extends ConfigValueArrayDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link ConfigValueBooleanArrayDef#getConfigType} 
          */
         CONFIG_TYPE,
         /** 
          * The type of this data attribute is java.util.List&lt;Boolean&gt;.
          * Is is returned by {@link ConfigValueBooleanArrayDef#getArray} 
          */
         ARRAY,
;
    }
