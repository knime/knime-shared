...
public class DefaultConfigValueByteDef extends DefaultConfigValueDef implements ConfigValueByteDef, LoadExceptionTreeProvider {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueByteDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<ConfigValueByteDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
