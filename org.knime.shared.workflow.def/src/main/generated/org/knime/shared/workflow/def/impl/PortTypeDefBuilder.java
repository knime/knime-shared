...
public class PortTypeDefBuilder {
    ...
    public PortTypeDefBuilder(final PortTypeDef toCopy) {
        setPortObjectClass(toCopy.getPortObjectClass());
        setPortObjectSpecClass(toCopy.getPortObjectSpecClass().orElse(null));
        setColor(toCopy.getColor().orElse(null));
        setHidden(toCopy.isHidden());
        setOptional(toCopy.isOptional());
