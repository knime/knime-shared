...
public class DefaultConfigValueIntArrayDef extends DefaultConfigValueArrayDef implements ConfigValueIntArrayDef, LoadExceptionTreeProvider {
     ...
     */
    DefaultConfigValueIntArrayDef(ConfigValueIntArrayDefBuilder builder) {
     ...
     */
    DefaultConfigValueIntArrayDef(ConfigValueIntArrayDef toCopy, final LoadException supplyException) {
     ...
     * @param toCopy source
     */
    public DefaultConfigValueIntArrayDef(ConfigValueIntArrayDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_array = toCopy.getArray();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultConfigValueIntArrayDef withException(ConfigValueIntArrayDef toCopy, final LoadException exception) {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueIntArrayDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<ConfigValueIntArrayDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
    ...
    public boolean equals(final Object o) {
        ...
        DefaultConfigValueIntArrayDef other = (DefaultConfigValueIntArrayDef)o;
