...
/**
 * Base interface for the configuration value classes, e.g., boolean, char, double
 *
...
public abstract class DefaultConfigValueDef extends DefaultConfigDef implements ConfigValueDef, LoadExceptionTreeProvider {
     ...
     * @param toCopy source
     */
    public DefaultConfigValueDef(ConfigValueDef toCopy) {
    ...
    // -----------------------------------------------------------------------------------------------------------------
    // Factory method to attach a LoadException to an existing ConfigValue
    // -----------------------------------------------------------------------------------------------------------------
    /**
     ...
     */
    static DefaultConfigValueDef withException(ConfigValueDef toCopy, final LoadException exception) {
    ...
    public boolean equals(final Object o) {
        ...
        DefaultConfigValueDef other = (DefaultConfigValueDef)o;
