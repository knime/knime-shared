...
public class DefaultConfigValuePasswordDef extends DefaultConfigValueDef implements ConfigValuePasswordDef, LoadExceptionTreeProvider {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValuePasswordDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<ConfigValuePasswordDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
