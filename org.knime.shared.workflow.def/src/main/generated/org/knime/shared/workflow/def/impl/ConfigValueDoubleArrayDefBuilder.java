...
/**
 * ConfigValueDoubleArrayDefBuilder
 * @author Martin Horn, KNIME GmbH, Konstanz, Germany
 * @author Carl Witt, KNIME AG, Zurich, Switzerland
 * @author Dionysios Stolis, KNIME GmbH, Berlin, Germany
 */
// @javax.annotation.Generated(value = {"com.knime.gateway.codegen.CoreCodegen", "src-gen/api/core/configs/org.knime.shared.workflow.def.impl.def-builder-config.json"})
public class ConfigValueDoubleArrayDefBuilder {
     ...
     */
    public ConfigValueDoubleArrayDefBuilder strict(){
        m__failFast = true;
        return this;
    }
     ...
     */
    Map<ConfigValueDoubleArrayDef.Attribute, LoadExceptionTree<?>> m_exceptionalChildren = new java.util.EnumMap<>(ConfigValueDoubleArrayDef.Attribute.class);
     ...
     */
    Optional<java.util.List<Double>> m_array = Optional.of(java.util.List.of());
    /** 
     ...
     */
    Optional<java.util.List<Double>> m_arrayIndividualElements = Optional.empty();
    /** 
     ...
     */
    private Optional<java.util.List<Double>> m_arrayBulkElements = Optional.empty();
     ...
     * @return this builder for fluent API.
     */ 
    public ConfigValueDoubleArrayDefBuilder setConfigType(final String configType) {
     ...
     * {@code hasExceptions(ConfigValueDoubleArrayDef.Attribute.CONFIG_TYPE)} will return true and and
     * {@code getExceptionalChildren().get(ConfigValueDoubleArrayDef.Attribute.CONFIG_TYPE)} will return the exception.
     * 
     * @param configType see {@link ConfigValueDoubleArrayDef#getConfigType}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setConfigType(String)
     */
    public ConfigValueDoubleArrayDefBuilder setConfigType(final FallibleSupplier<String> configType, String defaultValue) {
        java.util.Objects.requireNonNull(configType, () -> "No supplier for configType provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(ConfigValueDoubleArrayDef.Attribute.CONFIG_TYPE);
        try {
            ...
            m_exceptionalChildren.put(ConfigValueDoubleArrayDef.Attribute.CONFIG_TYPE, supplyException);
            if(m__failFast){
     ...
     */
    public ConfigValueDoubleArrayDefBuilder setArray(final java.util.List<Double> array) {
        setArray(() -> array);
        return this;
    }
     ...
     * {@code hasExceptions(ConfigValueDoubleArrayDef.Attribute.ARRAY)} will return true and and
     * {@code getExceptionalChildren().get(ConfigValueDoubleArrayDef.Attribute.ARRAY)} will return the exception.
     * 
     * @param array see {@link ConfigValueDoubleArrayDef#getArray}
     * 
     * @return this builder for fluent API.
     * @see #setArray(java.util.List<Double>)
     */
    public ConfigValueDoubleArrayDefBuilder setArray(final FallibleSupplier<java.util.List<Double>> array) {
        java.util.Objects.requireNonNull(array, () -> "No supplier for array provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(ConfigValueDoubleArrayDef.Attribute.ARRAY);
        try {
     ...
     * @return this builder for fluent API
     */
    public ConfigValueDoubleArrayDefBuilder addToArray(Double value){
    	addToArray(() -> value, /* default value will not be used */ value);
        return this;
    }
    
    /**
     * Adds the return value of the fallible supplier to the list returned by {@link ConfigValueDoubleArrayDef#getArray}. If the 
     ...
     * @return this builder for fluent API.
     */
    public ConfigValueDoubleArrayDefBuilder addToArray(FallibleSupplier<Double> value, Double defaultValue) {
    ...
    // -----------------------------------------------------------------------------------------------------------------
    /**
	 * @return the {@link ConfigValueDoubleArrayDef} created from the data passed to the setters. Implements 
     *      {@link LoadExceptionTree} to provide access to any load exceptions that have occurred during evaluation
     *      of the suppliers passed to the setters.
	 */
    public DefaultConfigValueDoubleArrayDef build() {
