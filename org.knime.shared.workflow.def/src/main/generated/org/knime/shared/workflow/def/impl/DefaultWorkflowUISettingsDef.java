...
public class DefaultWorkflowUISettingsDef implements WorkflowUISettingsDef, LoadExceptionTreeProvider {
     ...
     */
    DefaultWorkflowUISettingsDef(WorkflowUISettingsDefBuilder builder) {
     ...
     */
    DefaultWorkflowUISettingsDef(WorkflowUISettingsDef toCopy, final LoadException supplyException) {
     ...
     * @param toCopy source
     */
    public DefaultWorkflowUISettingsDef(WorkflowUISettingsDef toCopy) {
        m_snapToGrid = toCopy.isSnapToGrid();
        m_showGrid = toCopy.isShowGrid();
        m_gridX = toCopy.getGridX();
        m_gridY = toCopy.getGridY();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultWorkflowUISettingsDef withException(WorkflowUISettingsDef toCopy, final LoadException exception) {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(WorkflowUISettingsDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<WorkflowUISettingsDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
    ...
    public boolean equals(final Object o) {
        ...
        DefaultWorkflowUISettingsDef other = (DefaultWorkflowUISettingsDef)o;
