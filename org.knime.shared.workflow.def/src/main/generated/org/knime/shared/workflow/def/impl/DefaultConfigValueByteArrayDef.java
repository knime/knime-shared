...
public class DefaultConfigValueByteArrayDef extends DefaultConfigValueArrayDef implements ConfigValueByteArrayDef, LoadExceptionTreeProvider {
    ...
    @JsonProperty("array")
    protected Optional<byte[]> m_array;
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueByteArrayDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<ConfigValueByteArrayDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
