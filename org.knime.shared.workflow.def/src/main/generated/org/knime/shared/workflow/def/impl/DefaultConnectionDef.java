...
public class DefaultConnectionDef implements ConnectionDef, LoadExceptionTreeProvider {
     ...
     */
    DefaultConnectionDef(ConnectionDefBuilder builder) {
     ...
     */
    DefaultConnectionDef(ConnectionDef toCopy, final LoadException supplyException) {
     ...
     * @param toCopy source
     */
    public DefaultConnectionDef(ConnectionDef toCopy) {
        m_sourceID = toCopy.getSourceID();
        m_destID = toCopy.getDestID();
        m_sourcePort = toCopy.getSourcePort();
        m_destPort = toCopy.getDestPort();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultConnectionDef withException(ConnectionDef toCopy, final LoadException exception) {
     ...
     * returns the uiSettings as DefaultConnectionUISettingsDef which provides getters for the exceptions. Otherwise an empty optional.
     */
    @JsonIgnore
    ...
    public boolean equals(final Object o) {
        ...
        DefaultConnectionDef other = (DefaultConnectionDef)o;
