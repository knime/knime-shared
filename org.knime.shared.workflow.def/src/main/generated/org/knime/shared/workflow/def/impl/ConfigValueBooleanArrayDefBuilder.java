...
/**
 * ConfigValueBooleanArrayDefBuilder
 * @author Martin Horn, KNIME GmbH, Konstanz, Germany
 * @author Carl Witt, KNIME AG, Zurich, Switzerland
 * @author Dionysios Stolis, KNIME GmbH, Berlin, Germany
 */
// @javax.annotation.Generated(value = {"com.knime.gateway.codegen.CoreCodegen", "src-gen/api/core/configs/org.knime.shared.workflow.def.impl.def-builder-config.json"})
public class ConfigValueBooleanArrayDefBuilder {
     ...
     */
    public ConfigValueBooleanArrayDefBuilder strict(){
        m__failFast = true;
        return this;
    }
     ...
     */
    Map<ConfigValueBooleanArrayDef.Attribute, LoadExceptionTree<?>> m_exceptionalChildren = new java.util.EnumMap<>(ConfigValueBooleanArrayDef.Attribute.class);
     ...
     */
    Optional<java.util.List<Boolean>> m_array = Optional.of(java.util.List.of());
    /** 
     ...
     */
    Optional<java.util.List<Boolean>> m_arrayIndividualElements = Optional.empty();
    /** 
     ...
     */
    private Optional<java.util.List<Boolean>> m_arrayBulkElements = Optional.empty();
     ...
     */
    public ConfigValueBooleanArrayDefBuilder() {
    }

    /**
     * Create a new builder from an existing instance.
     */
    public ConfigValueBooleanArrayDefBuilder(final ConfigValueBooleanArrayDef toCopy) {
     ...
     * @return this builder for fluent API.
     */ 
    public ConfigValueBooleanArrayDefBuilder setConfigType(final String configType) {
     ...
     * {@code hasExceptions(ConfigValueBooleanArrayDef.Attribute.CONFIG_TYPE)} will return true and and
     * {@code getExceptionalChildren().get(ConfigValueBooleanArrayDef.Attribute.CONFIG_TYPE)} will return the exception.
     * 
     * @param configType see {@link ConfigValueBooleanArrayDef#getConfigType}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setConfigType(String)
     */
    public ConfigValueBooleanArrayDefBuilder setConfigType(final FallibleSupplier<String> configType, String defaultValue) {
        java.util.Objects.requireNonNull(configType, () -> "No supplier for configType provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(ConfigValueBooleanArrayDef.Attribute.CONFIG_TYPE);
        try {
            ...
            m_exceptionalChildren.put(ConfigValueBooleanArrayDef.Attribute.CONFIG_TYPE, supplyException);
            if(m__failFast){
     ...
     */
    public ConfigValueBooleanArrayDefBuilder setArray(final java.util.List<Boolean> array) {
        setArray(() -> array);
        return this;
    }
     ...
     * {@code hasExceptions(ConfigValueBooleanArrayDef.Attribute.ARRAY)} will return true and and
     * {@code getExceptionalChildren().get(ConfigValueBooleanArrayDef.Attribute.ARRAY)} will return the exception.
     * 
     * @param array see {@link ConfigValueBooleanArrayDef#getArray}
     * 
     * @return this builder for fluent API.
     * @see #setArray(java.util.List<Boolean>)
     */
    public ConfigValueBooleanArrayDefBuilder setArray(final FallibleSupplier<java.util.List<Boolean>> array) {
        java.util.Objects.requireNonNull(array, () -> "No supplier for array provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(ConfigValueBooleanArrayDef.Attribute.ARRAY);
        try {
     ...
     * @return this builder for fluent API
     */
    public ConfigValueBooleanArrayDefBuilder addToArray(Boolean value){
    	addToArray(() -> value, /* default value will not be used */ value);
        return this;
    }
    
    /**
     * Adds the return value of the fallible supplier to the list returned by {@link ConfigValueBooleanArrayDef#getArray}. If the 
     ...
     * @return this builder for fluent API.
     */
    public ConfigValueBooleanArrayDefBuilder addToArray(FallibleSupplier<Boolean> value, Boolean defaultValue) {
    ...
    // -----------------------------------------------------------------------------------------------------------------
    /**
	 * @return the {@link ConfigValueBooleanArrayDef} created from the data passed to the setters. Implements 
     *      {@link LoadExceptionTree} to provide access to any load exceptions that have occurred during evaluation
     *      of the suppliers passed to the setters.
	 */
    public DefaultConfigValueBooleanArrayDef build() {
        ...
        var arrayLoadExceptionTree = org.knime.shared.workflow.def.SimpleLoadExceptionTree
