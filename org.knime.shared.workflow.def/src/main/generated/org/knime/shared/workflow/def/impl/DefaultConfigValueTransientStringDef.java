...
public class DefaultConfigValueTransientStringDef extends DefaultConfigValueDef implements ConfigValueTransientStringDef, LoadExceptionTreeProvider {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueTransientStringDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<ConfigValueTransientStringDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
