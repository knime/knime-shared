...
public class ComponentMetadataDefBuilder {
    ...
    public ComponentMetadataDefBuilder(final ComponentMetadataDef toCopy) {
        setDescription(toCopy.getDescription().orElse(null));
        setInPortMetadata(toCopy.getInPortMetadata().orElse(null));
        setOutPortMetadata(toCopy.getOutPortMetadata().orElse(null));
        setIcon(toCopy.getIcon().orElse(null));
        setComponentType(toCopy.getComponentType().orElse(null));
    }
    ...
    public DefaultComponentMetadataDef build() {
        ...
        var inPortMetadataLoadExceptionTree = org.knime.shared.workflow.def.SimpleLoadExceptionTree
        ...
        var outPortMetadataLoadExceptionTree = org.knime.shared.workflow.def.SimpleLoadExceptionTree
