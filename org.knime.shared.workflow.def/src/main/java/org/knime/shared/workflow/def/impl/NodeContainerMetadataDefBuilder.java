...
/**
 * NodeContainerMetadataDefBuilder
...
public class NodeContainerMetadataDefBuilder {
     ...
     */
    Map<NodeContainerMetadataDef.Attribute, LoadExceptionTree<?>> m_exceptionalChildren = new java.util.EnumMap<>(NodeContainerMetadataDef.Attribute.class);
     ...
     */
    public NodeContainerMetadataDefBuilder() {
    }

    /**
     * Create a new builder from an existing instance.
     */
    public NodeContainerMetadataDefBuilder(final NodeContainerMetadataDef toCopy) {
     ...
     * @since 5.1
     */ 
    public NodeContainerMetadataDefBuilder setAuthor(final String author) {
     ...
     * {@code hasExceptions(NodeContainerMetadataDef.Attribute.AUTHOR)} will return true and and
     * {@code getExceptionalChildren().get(NodeContainerMetadataDef.Attribute.AUTHOR)} will return the exception.
     * 
     * @param author see {@link NodeContainerMetadataDef#getAuthor}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setAuthor(String)
     * @since 5.1
     */
    public NodeContainerMetadataDefBuilder setAuthor(final FallibleSupplier<String> author, String defaultValue) {
        java.util.Objects.requireNonNull(author, () -> "No supplier for author provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(NodeContainerMetadataDef.Attribute.AUTHOR);
        try {
            m_author = author.get();
	    } catch (Exception e) {
            ...
            m_exceptionalChildren.put(NodeContainerMetadataDef.Attribute.AUTHOR, supplyException);
	    }   
        return this;
    }
    // -----------------------------------------------------------------------------------------------------------------
     ...
     * @since 5.1
     */ 
    public NodeContainerMetadataDefBuilder setCreated(final OffsetDateTime created) {
     ...
     * Sets the field using a supplier that may throw an exception. If an exception is thrown, it is recorded and can
     * be accessed through {@link LoadExceptionTree} interface of the instance build by this builder.
     * {@code hasExceptions(NodeContainerMetadataDef.Attribute.CREATED)} will return true and and
     * {@code getExceptionalChildren().get(NodeContainerMetadataDef.Attribute.CREATED)} will return the exception.
     * 
     * @param created see {@link NodeContainerMetadataDef#getCreated}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setCreated(OffsetDateTime)
     * @since 5.1
     */
    public NodeContainerMetadataDefBuilder setCreated(final FallibleSupplier<OffsetDateTime> created, OffsetDateTime defaultValue) {
        java.util.Objects.requireNonNull(created, () -> "No supplier for created provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(NodeContainerMetadataDef.Attribute.CREATED);
        try {
            ...
            m_exceptionalChildren.put(NodeContainerMetadataDef.Attribute.CREATED, supplyException);
	    }   
        return this;
    }
    // -----------------------------------------------------------------------------------------------------------------
     ...
     * @since 5.1
     */ 
    public NodeContainerMetadataDefBuilder setLastModified(final OffsetDateTime lastModified) {
     ...
     * Sets the field using a supplier that may throw an exception. If an exception is thrown, it is recorded and can
     * be accessed through {@link LoadExceptionTree} interface of the instance build by this builder.
     * {@code hasExceptions(NodeContainerMetadataDef.Attribute.LAST_MODIFIED)} will return true and and
     * {@code getExceptionalChildren().get(NodeContainerMetadataDef.Attribute.LAST_MODIFIED)} will return the exception.
     * 
     * @param lastModified see {@link NodeContainerMetadataDef#getLastModified}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setLastModified(OffsetDateTime)
     * @since 5.1
     */
    public NodeContainerMetadataDefBuilder setLastModified(final FallibleSupplier<OffsetDateTime> lastModified, OffsetDateTime defaultValue) {
        java.util.Objects.requireNonNull(lastModified, () -> "No supplier for lastModified provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(NodeContainerMetadataDef.Attribute.LAST_MODIFIED);
        try {
            ...
            m_exceptionalChildren.put(NodeContainerMetadataDef.Attribute.LAST_MODIFIED, supplyException);
	    }   
        return this;
    }
    // -----------------------------------------------------------------------------------------------------------------
     ...
     * @return this builder for fluent API.
     */ 
    public NodeContainerMetadataDefBuilder setDescription(final String description) {
     ...
     * Sets the field using a supplier that may throw an exception. If an exception is thrown, it is recorded and can
     * be accessed through {@link LoadExceptionTree} interface of the instance build by this builder.
     * {@code hasExceptions(NodeContainerMetadataDef.Attribute.DESCRIPTION)} will return true and and
     * {@code getExceptionalChildren().get(NodeContainerMetadataDef.Attribute.DESCRIPTION)} will return the exception.
     * 
     * @param description see {@link NodeContainerMetadataDef#getDescription}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setDescription(String)
     */
    public NodeContainerMetadataDefBuilder setDescription(final FallibleSupplier<String> description, String defaultValue) {
        java.util.Objects.requireNonNull(description, () -> "No supplier for description provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(NodeContainerMetadataDef.Attribute.DESCRIPTION);
        try {
            ...
            m_exceptionalChildren.put(NodeContainerMetadataDef.Attribute.DESCRIPTION, supplyException);
	    }   
        return this;
    }
    // -----------------------------------------------------------------------------------------------------------------
     ...
     * @since 5.1
     */
    public NodeContainerMetadataDefBuilder setTags(final java.util.List<String> tags) {
        setTags(() -> tags);
        return this;
    }
     ...
     * {@code hasExceptions(NodeContainerMetadataDef.Attribute.TAGS)} will return true and and
     * {@code getExceptionalChildren().get(NodeContainerMetadataDef.Attribute.TAGS)} will return the exception.
     * 
     * @param tags see {@link NodeContainerMetadataDef#getTags}
     * 
     * @return this builder for fluent API.
     * @see #setTags(java.util.List<String>)
     * @since 5.1
     */
    public NodeContainerMetadataDefBuilder setTags(final FallibleSupplier<java.util.List<String>> tags) {
        java.util.Objects.requireNonNull(tags, () -> "No supplier for tags provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(NodeContainerMetadataDef.Attribute.TAGS);
        try {
     ...
     * @since 5.1
     */
    public NodeContainerMetadataDefBuilder addToTags(String value){
    	addToTags(() -> value, /* default value will not be used */ value);
        return this;
    }
    
    /**
     * Adds the return value of the fallible supplier to the list returned by {@link NodeContainerMetadataDef#getTags}. If the 
     ...
     * @since 5.1
     */
    public NodeContainerMetadataDefBuilder addToTags(FallibleSupplier<String> value, String defaultValue) {
        String toAdd = null;
        try {
            toAdd = value.get();
        } catch (Exception e) {
     ...
     * @since 5.1
     */
    public NodeContainerMetadataDefBuilder setLinks(final java.util.List<LinkDef> links) {
        setLinks(() -> links);
        return this;
    }
     ...
     * {@code hasExceptions(NodeContainerMetadataDef.Attribute.LINKS)} will return true and and
     * {@code getExceptionalChildren().get(NodeContainerMetadataDef.Attribute.LINKS)} will return the exception.
     * 
     * @param links see {@link NodeContainerMetadataDef#getLinks}
     * 
     * @return this builder for fluent API.
     * @see #setLinks(java.util.List<LinkDef>)
     * @since 5.1
     */
    public NodeContainerMetadataDefBuilder setLinks(final FallibleSupplier<java.util.List<LinkDef>> links) {
        java.util.Objects.requireNonNull(links, () -> "No supplier for links provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(NodeContainerMetadataDef.Attribute.LINKS);
        try {
     ...
     * @since 5.1
     */
    public NodeContainerMetadataDefBuilder addToLinks(LinkDef value){
    	addToLinks(() -> value, /* default value will not be used */ value);
        return this;
    }
    
    /**
     * Adds the return value of the fallible supplier to the list returned by {@link NodeContainerMetadataDef#getLinks}. If the 
     * fallible supplier fails, adds the default value instead and registers a {@link LoadException} for the added element's index in the list.
     *
     ...
     * @since 5.1
     */
    public NodeContainerMetadataDefBuilder addToLinks(FallibleSupplier<LinkDef> value, LinkDef defaultValue) {
        LinkDef toAdd = null;
        try {
            toAdd = value.get();
        } catch (Exception e) {
     ...
     * @since 5.1
     */ 
    public NodeContainerMetadataDefBuilder setContentType(final ContentTypeEnum contentType) {
     ...
     * Sets the field using a supplier that may throw an exception. If an exception is thrown, it is recorded and can
     * be accessed through {@link LoadExceptionTree} interface of the instance build by this builder.
     * {@code hasExceptions(NodeContainerMetadataDef.Attribute.CONTENT_TYPE)} will return true and and
     * {@code getExceptionalChildren().get(NodeContainerMetadataDef.Attribute.CONTENT_TYPE)} will return the exception.
     * 
     * @param contentType see {@link NodeContainerMetadataDef#getContentType}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setContentType(ContentTypeEnum)
     * @since 5.1
     */
    public NodeContainerMetadataDefBuilder setContentType(final FallibleSupplier<ContentTypeEnum> contentType, ContentTypeEnum defaultValue) {
        java.util.Objects.requireNonNull(contentType, () -> "No supplier for contentType provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(NodeContainerMetadataDef.Attribute.CONTENT_TYPE);
        try {
            ...
            m_exceptionalChildren.put(NodeContainerMetadataDef.Attribute.CONTENT_TYPE, supplyException);
	    }   
        return this;
    }
    // -----------------------------------------------------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------------------------------------------------
    /**
	 * @return the {@link NodeContainerMetadataDef} created from the data passed to the setters. Implements 
     *      {@link LoadExceptionTree} to provide access to any load exceptions that have occurred during evaluation
     *      of the suppliers passed to the setters.
	 */
    public DefaultNodeContainerMetadataDef build() {
        ...
        var tagsLoadExceptionTree = org.knime.core.util.workflow.def.SimpleLoadExceptionTree
            ...
            m_exceptionalChildren.put(NodeContainerMetadataDef.Attribute.TAGS, tagsLoadExceptionTree);
        }
        ...
        if(linksLoadExceptionTree.hasExceptions()){
            m_exceptionalChildren.put(NodeContainerMetadataDef.Attribute.LINKS, linksLoadExceptionTree);
        }
        
        return new DefaultNodeContainerMetadataDef(this);
    }    
