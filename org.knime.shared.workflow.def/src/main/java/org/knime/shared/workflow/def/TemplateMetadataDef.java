...
import org.knime.shared.workflow.def.impl.DefaultTemplateMetadataDef;
 ...
 */
@JsonDeserialize(as = DefaultTemplateMetadataDef.class)
...
public interface TemplateMetadataDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link TemplateMetadataDef#getVersion} 
          */
         VERSION,
;
    }
  ...
  /**
   * @return When the template was last updated. If this date is newer than the updated date of the linked component or metanode, an update is available., never <code>null</code>
   **/
