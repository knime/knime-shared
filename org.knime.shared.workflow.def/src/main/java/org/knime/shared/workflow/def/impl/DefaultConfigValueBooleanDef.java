...
public class DefaultConfigValueBooleanDef extends DefaultConfigValueDef implements ConfigValueBooleanDef {
     ...
     */
    DefaultConfigValueBooleanDef(ConfigValueBooleanDefBuilder builder) {
     ...
     */
    DefaultConfigValueBooleanDef(ConfigValueBooleanDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof DefaultConfigValueBooleanDef){
            var childTree = ((DefaultConfigValueBooleanDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public DefaultConfigValueBooleanDef(ConfigValueBooleanDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_value = toCopy.isValue();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultConfigValueBooleanDef withException(ConfigValueBooleanDef toCopy, final LoadException exception) {
    ...
    public boolean equals(final Object o) {
        ...
        DefaultConfigValueBooleanDef other = (DefaultConfigValueBooleanDef)o;
