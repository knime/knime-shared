...
public class DefaultConfigValueLongDef extends DefaultConfigValueDef implements ConfigValueLongDef {
    ...
    DefaultConfigValueLongDef(ConfigValueLongDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof DefaultConfigValueLongDef){
            var childTree = ((DefaultConfigValueLongDef)toCopy).getLoadExceptionTree();                
