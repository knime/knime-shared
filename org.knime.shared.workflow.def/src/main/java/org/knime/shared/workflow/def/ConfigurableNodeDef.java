...
public interface ConfigurableNodeDef extends BaseNodeDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link ConfigurableNodeDef#getCustomDescription} 
          */
         CUSTOM_DESCRIPTION,
         /** 
          * The type of this data attribute is {@link NodeAnnotationDef}.
          * Is is returned by {@link ConfigurableNodeDef#getAnnotation} 
          */
         ANNOTATION,
         /** 
          ...
          * Is is returned by {@link ConfigurableNodeDef#getJobManager} 
          */
         JOB_MANAGER,
         /** 
          * The type of this data attribute is {@link ConfigMapDef}.
          * Is is returned by {@link ConfigurableNodeDef#getModelSettings} 
          */
         MODEL_SETTINGS,
         /** 
          * The type of this data attribute is {@link ConfigMapDef}.
          * Is is returned by {@link ConfigurableNodeDef#getInternalNodeSubSettings} 
          */
         INTERNAL_NODE_SUB_SETTINGS,
         /** 
          * The type of this data attribute is {@link ConfigMapDef}.
          * Is is returned by {@link ConfigurableNodeDef#getVariableSettings} 
          */
         VARIABLE_SETTINGS,
;
    }
