...
/**
 * DefaultConfigValueBooleanArrayDef
 *
...
public class DefaultConfigValueBooleanArrayDef extends DefaultConfigValueArrayDef implements ConfigValueBooleanArrayDef {

    /** this either points to a LoadException (which implements LoadExceptionTree<Void>) or to
     * a LoadExceptionTree<ConfigValueBooleanArrayDef.Attribute> instance. */
    final private Optional<LoadExceptionTree<?>> m_exceptionTree;

    @JsonProperty("array")
    protected java.util.List<Boolean> m_array;
    ...
    /**
     * Builder constructor. Only for use in {@link ConfigValueBooleanArrayDefBuilder}.
     * @param builder source
     */
    DefaultConfigValueBooleanArrayDef(ConfigValueBooleanArrayDefBuilder builder) {
     ...
     * Only for use in {@link ConfigValueBooleanArrayDefBuilder}.
     ...
     */
    DefaultConfigValueBooleanArrayDef(ConfigValueBooleanArrayDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof DefaultConfigValueBooleanArrayDef){
            var childTree = ((DefaultConfigValueBooleanArrayDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public DefaultConfigValueBooleanArrayDef(ConfigValueBooleanArrayDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_array = toCopy.getArray();
    ...
    // -----------------------------------------------------------------------------------------------------------------
    // Factory method to attach a LoadException to an existing ConfigValueBooleanArray
    // -----------------------------------------------------------------------------------------------------------------
    /**
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultConfigValueBooleanArrayDef withException(ConfigValueBooleanArrayDef toCopy, final LoadException exception) {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueBooleanArrayDef.Attribute attribute){
        return m_exceptionTree.flatMap(t -> {
            if(t instanceof LoadException) return Optional.empty();
            // if the tree is not a leaf, it is typed to ConfigValueBooleanArrayDef.Attribute
            return ((LoadExceptionTree<ConfigValueBooleanArrayDef.Attribute>)t).getExceptionTree(attribute);
        });
    }
    ...
    @Override
    public java.util.List<Boolean> getArray() {
        return m_array;
    }
    ...
    public Optional<LoadException> getConfigTypeSupplyException(){
    	return getLoadExceptionTree(ConfigValueBooleanArrayDef.Attribute.CONFIG_TYPE).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getArraySupplyException(){
    	return getLoadExceptionTree(ConfigValueBooleanArrayDef.Attribute.ARRAY).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadExceptionTree<Integer>> getArrayExceptionTree(){
    	return getLoadExceptionTree(ConfigValueBooleanArrayDef.Attribute.ARRAY).map(les -> (LoadExceptionTree<Integer>)les);
    }
    ...
    public boolean equals(final Object o) {
        ...
        DefaultConfigValueBooleanArrayDef other = (DefaultConfigValueBooleanArrayDef)o;
