...
import org.knime.shared.workflow.def.impl.DefaultLinkDef;
 ...
 */
@JsonDeserialize(as = DefaultLinkDef.class)
...
public interface LinkDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link LinkDef#getUrl} 
          */
         URL,
         /** 
          * The type of this data attribute is {@link String}.
          * Is is returned by {@link LinkDef#getText} 
          */
         TEXT,
;
    }
