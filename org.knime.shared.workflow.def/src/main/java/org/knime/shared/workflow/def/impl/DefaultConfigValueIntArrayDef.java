...
public class DefaultConfigValueIntArrayDef extends DefaultConfigValueArrayDef implements ConfigValueIntArrayDef {
    ...
    DefaultConfigValueIntArrayDef(ConfigValueIntArrayDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof DefaultConfigValueIntArrayDef){
            var childTree = ((DefaultConfigValueIntArrayDef)toCopy).getLoadExceptionTree();                
