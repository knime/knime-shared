...
public class DefaultConfigValueIntDef extends DefaultConfigValueDef implements ConfigValueIntDef, LoadExceptionTreeProvider {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueIntDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<ConfigValueIntDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
