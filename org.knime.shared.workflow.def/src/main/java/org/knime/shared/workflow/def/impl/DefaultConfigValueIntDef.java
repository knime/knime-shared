...
public class DefaultConfigValueIntDef extends DefaultConfigValueDef implements ConfigValueIntDef {
     ...
     */
    DefaultConfigValueIntDef(ConfigValueIntDefBuilder builder) {
     ...
     */
    DefaultConfigValueIntDef(ConfigValueIntDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof DefaultConfigValueIntDef){
            var childTree = ((DefaultConfigValueIntDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public DefaultConfigValueIntDef(ConfigValueIntDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_value = toCopy.getValue();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultConfigValueIntDef withException(ConfigValueIntDef toCopy, final LoadException exception) {
    ...
    public boolean equals(final Object o) {
        ...
        DefaultConfigValueIntDef other = (DefaultConfigValueIntDef)o;
