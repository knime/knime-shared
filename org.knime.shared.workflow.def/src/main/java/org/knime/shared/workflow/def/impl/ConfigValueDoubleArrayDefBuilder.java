...
public class ConfigValueDoubleArrayDefBuilder {
     ...
     */
    Optional<java.util.List<Double>> m_array = Optional.of(new java.util.ArrayList<>());
    /** Temporarily holds onto elements set as a whole with setArray these are added to m_array in build */
    private Optional<java.util.List<Double>> m_arrayBulkElements = Optional.of(new java.util.ArrayList<>());
