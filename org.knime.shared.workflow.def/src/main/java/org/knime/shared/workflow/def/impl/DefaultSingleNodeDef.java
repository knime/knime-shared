...
public abstract class DefaultSingleNodeDef extends DefaultBaseNodeDef implements SingleNodeDef, LoadExceptionTreeProvider {
     ...
     * @param toCopy source
     */
    public DefaultSingleNodeDef(SingleNodeDef toCopy) {
        m_id = toCopy.getId();
    ...
    // -----------------------------------------------------------------------------------------------------------------
    // Factory method to attach a LoadException to an existing SingleNode
    // -----------------------------------------------------------------------------------------------------------------
    /**
     ...
     */
    static DefaultSingleNodeDef withException(SingleNodeDef toCopy, final LoadException exception) {
    ...
    public boolean equals(final Object o) {
        ...
        DefaultSingleNodeDef other = (DefaultSingleNodeDef)o;
