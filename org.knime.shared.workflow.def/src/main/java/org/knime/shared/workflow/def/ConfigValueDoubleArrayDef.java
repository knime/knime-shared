...
/**
 * ConfigValueDoubleArrayDef
 *
 * @author Martin Horn, KNIME GmbH, Konstanz, Germany
 * @author Carl Witt, KNIME AG, Zurich, Switzerland
 * @author Dionysios Stolis, KNIME GmbH, Berlin, Germany
 */
@JsonDeserialize(as = DefaultConfigValueDoubleArrayDef.class)
...
public interface ConfigValueDoubleArrayDef extends ConfigValueArrayDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link ConfigValueDoubleArrayDef#getConfigType} 
          */
         CONFIG_TYPE,
         /** 
          * The type of this data attribute is java.util.List&lt;Double&gt;.
          * Is is returned by {@link ConfigValueDoubleArrayDef#getArray} 
          */
         ARRAY,
;
    }
