...
public class AuthorInformationDefBuilder {
    ...
    public AuthorInformationDefBuilder(final AuthorInformationDef toCopy) {
        setAuthoredBy(toCopy.getAuthoredBy());
        setAuthoredWhen(toCopy.getAuthoredWhen());
        setLastEditedBy(toCopy.getLastEditedBy().orElse(null));
        setLastEditedWhen(toCopy.getLastEditedWhen().orElse(null));
    }
