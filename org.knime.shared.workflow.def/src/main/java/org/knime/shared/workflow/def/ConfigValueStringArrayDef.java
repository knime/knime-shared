...
/**
 * ConfigValueStringArrayDef
 *
 * @author Martin Horn, KNIME GmbH, Konstanz, Germany
 * @author Carl Witt, KNIME AG, Zurich, Switzerland
 * @author Dionysios Stolis, KNIME GmbH, Berlin, Germany
 */
@JsonDeserialize(as = DefaultConfigValueStringArrayDef.class)
...
public interface ConfigValueStringArrayDef extends ConfigValueArrayDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link ConfigValueStringArrayDef#getConfigType} 
          */
         CONFIG_TYPE,
         /** 
          * The type of this data attribute is java.util.List&lt;String&gt;.
          * Is is returned by {@link ConfigValueStringArrayDef#getArray} 
          */
         ARRAY,
;
    }
