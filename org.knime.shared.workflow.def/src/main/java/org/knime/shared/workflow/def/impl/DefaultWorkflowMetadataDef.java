...
import org.knime.shared.workflow.def.impl.DefaultNodeContainerMetadataDef;
...
public class DefaultWorkflowMetadataDef extends DefaultNodeContainerMetadataDef implements WorkflowMetadataDef {

    /** this either points to a LoadException (which implements LoadExceptionTree<Void>) or to
     * a LoadExceptionTree<WorkflowMetadataDef.Attribute> instance. */
    ...
    /**
     * Builder constructor. Only for use in {@link WorkflowMetadataDefBuilder}.
     * @param builder source
     */
    DefaultWorkflowMetadataDef(WorkflowMetadataDefBuilder builder) {
     ...
     * Only for use in {@link WorkflowMetadataDefBuilder}.
     ...
     */
    DefaultWorkflowMetadataDef(WorkflowMetadataDef toCopy, final LoadException supplyException) {
        Objects.requireNonNull(supplyException);
        toCopy = Objects.requireNonNullElse(toCopy, new WorkflowMetadataDefBuilder().build());
        ...
        if(toCopy instanceof DefaultWorkflowMetadataDef){
            var childTree = ((DefaultWorkflowMetadataDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public DefaultWorkflowMetadataDef(WorkflowMetadataDef toCopy) {
        m_author = toCopy.getAuthor();
        m_created = toCopy.getCreated();
        m_lastModified = toCopy.getLastModified();
        m_description = toCopy.getDescription();
    ...
    // -----------------------------------------------------------------------------------------------------------------
    // Factory method to attach a LoadException to an existing WorkflowMetadata
    // -----------------------------------------------------------------------------------------------------------------
    /**
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultWorkflowMetadataDef withException(WorkflowMetadataDef toCopy, final LoadException exception) {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(WorkflowMetadataDef.Attribute attribute){
        return m_exceptionTree.flatMap(t -> {
            if(t instanceof LoadException) return Optional.empty();
            // if the tree is not a leaf, it is typed to WorkflowMetadataDef.Attribute
            return ((LoadExceptionTree<WorkflowMetadataDef.Attribute>)t).getExceptionTree(attribute);
        });
    }
    ...
    public Optional<LoadException> getAuthorSupplyException(){
    	return getLoadExceptionTree(WorkflowMetadataDef.Attribute.AUTHOR).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getCreatedSupplyException(){
    	return getLoadExceptionTree(WorkflowMetadataDef.Attribute.CREATED).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getLastModifiedSupplyException(){
    	return getLoadExceptionTree(WorkflowMetadataDef.Attribute.LAST_MODIFIED).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getDescriptionSupplyException(){
    	return getLoadExceptionTree(WorkflowMetadataDef.Attribute.DESCRIPTION).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getTagsSupplyException(){
    	return getLoadExceptionTree(WorkflowMetadataDef.Attribute.TAGS).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadExceptionTree<Integer>> getTagsExceptionTree(){
    	return getLoadExceptionTree(WorkflowMetadataDef.Attribute.TAGS).map(les -> (LoadExceptionTree<Integer>)les);
    }
    ...
    public Optional<LoadException> getLinksSupplyException(){
    	return getLoadExceptionTree(WorkflowMetadataDef.Attribute.LINKS).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadExceptionTree<Integer>> getLinksExceptionTree(){
    	return getLoadExceptionTree(WorkflowMetadataDef.Attribute.LINKS).map(let -> (LoadExceptionTree<Integer>)let);
    }
    ...
    public Optional<LoadException> getContentTypeSupplyException(){
    	return getLoadExceptionTree(WorkflowMetadataDef.Attribute.CONTENT_TYPE).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public boolean equals(final Object o) {
        ...
        DefaultWorkflowMetadataDef other = (DefaultWorkflowMetadataDef)o;
