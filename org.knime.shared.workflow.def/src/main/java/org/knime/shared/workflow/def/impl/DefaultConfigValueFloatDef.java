...
public class DefaultConfigValueFloatDef extends DefaultConfigValueDef implements ConfigValueFloatDef, LoadExceptionTreeProvider {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueFloatDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<ConfigValueFloatDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
