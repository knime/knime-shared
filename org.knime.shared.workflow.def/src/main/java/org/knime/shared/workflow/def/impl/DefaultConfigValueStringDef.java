...
public class DefaultConfigValueStringDef extends DefaultConfigValueDef implements ConfigValueStringDef {
     ...
     */
    DefaultConfigValueStringDef(ConfigValueStringDefBuilder builder) {
     ...
     */
    DefaultConfigValueStringDef(ConfigValueStringDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof DefaultConfigValueStringDef){
            var childTree = ((DefaultConfigValueStringDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public DefaultConfigValueStringDef(ConfigValueStringDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_value = toCopy.getValue();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultConfigValueStringDef withException(ConfigValueStringDef toCopy, final LoadException exception) {
    ...
    public boolean equals(final Object o) {
        ...
        DefaultConfigValueStringDef other = (DefaultConfigValueStringDef)o;
