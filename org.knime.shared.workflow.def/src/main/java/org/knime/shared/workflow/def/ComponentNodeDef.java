...
public interface ComponentNodeDef extends ConfigurableNodeDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link ComponentNodeDef#getCustomDescription} 
          */
         CUSTOM_DESCRIPTION,
         /** 
          * The type of this data attribute is {@link NodeAnnotationDef}.
          * Is is returned by {@link ComponentNodeDef#getAnnotation} 
          */
         ANNOTATION,
         /** 
          ...
          * Is is returned by {@link ComponentNodeDef#getJobManager} 
          */
         JOB_MANAGER,
         /** 
          * The type of this data attribute is {@link ConfigMapDef}.
          * Is is returned by {@link ComponentNodeDef#getModelSettings} 
          */
         MODEL_SETTINGS,
         /** 
          * The type of this data attribute is {@link ConfigMapDef}.
          * Is is returned by {@link ComponentNodeDef#getInternalNodeSubSettings} 
          */
         INTERNAL_NODE_SUB_SETTINGS,
         /** 
          * The type of this data attribute is {@link ConfigMapDef}.
          * Is is returned by {@link ComponentNodeDef#getVariableSettings} 
          */
         VARIABLE_SETTINGS,
         /** 
          ...
          * Is is returned by {@link ComponentNodeDef#getInPorts} 
          */
         IN_PORTS,
         /** 
          * The type of this data attribute is java.util.List&lt;PortDef&gt;.
          * Is is returned by {@link ComponentNodeDef#getOutPorts} 
          */
         OUT_PORTS,
         /** 
          * The type of this data attribute is {@link CipherDef}.
          * Is is returned by {@link ComponentNodeDef#getCipher} 
          */
         CIPHER,
         /**  
          ...
          * Is is returned by {@link ComponentNodeDef#getMetadata} 
          */
         METADATA,
         /** 
