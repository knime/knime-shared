...
/**
 * DefaultConfigValueStringArrayDef
 *
...
public class DefaultConfigValueStringArrayDef extends DefaultConfigValueArrayDef implements ConfigValueStringArrayDef {
     ...
     */
    DefaultConfigValueStringArrayDef(ConfigValueStringArrayDefBuilder builder) {
     ...
     */
    DefaultConfigValueStringArrayDef(ConfigValueStringArrayDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof DefaultConfigValueStringArrayDef){
            var childTree = ((DefaultConfigValueStringArrayDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public DefaultConfigValueStringArrayDef(ConfigValueStringArrayDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_array = toCopy.getArray();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultConfigValueStringArrayDef withException(ConfigValueStringArrayDef toCopy, final LoadException exception) {
    ...
    public boolean equals(final Object o) {
        ...
        DefaultConfigValueStringArrayDef other = (DefaultConfigValueStringArrayDef)o;
