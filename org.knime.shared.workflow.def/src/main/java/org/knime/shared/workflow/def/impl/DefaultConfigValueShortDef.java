...
public class DefaultConfigValueShortDef extends DefaultConfigValueDef implements ConfigValueShortDef, LoadExceptionTreeProvider {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueShortDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<ConfigValueShortDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
