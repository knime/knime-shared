...
/**
 * DefaultConfigValueDoubleArrayDef
 *
...
public class DefaultConfigValueDoubleArrayDef extends DefaultConfigValueArrayDef implements ConfigValueDoubleArrayDef {

    /** this either points to a LoadException (which implements LoadExceptionTree<Void>) or to
     * a LoadExceptionTree<ConfigValueDoubleArrayDef.Attribute> instance. */
    final private Optional<LoadExceptionTree<?>> m_exceptionTree;

    @JsonProperty("array")
    protected java.util.List<Double> m_array;
    ...
    /**
     * Builder constructor. Only for use in {@link ConfigValueDoubleArrayDefBuilder}.
     * @param builder source
     */
    DefaultConfigValueDoubleArrayDef(ConfigValueDoubleArrayDefBuilder builder) {
     ...
     * Only for use in {@link ConfigValueDoubleArrayDefBuilder}.
     ...
     */
    DefaultConfigValueDoubleArrayDef(ConfigValueDoubleArrayDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof DefaultConfigValueDoubleArrayDef){
            var childTree = ((DefaultConfigValueDoubleArrayDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public DefaultConfigValueDoubleArrayDef(ConfigValueDoubleArrayDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_array = toCopy.getArray();
    ...
    // -----------------------------------------------------------------------------------------------------------------
    // Factory method to attach a LoadException to an existing ConfigValueDoubleArray
    // -----------------------------------------------------------------------------------------------------------------
    /**
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultConfigValueDoubleArrayDef withException(ConfigValueDoubleArrayDef toCopy, final LoadException exception) {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueDoubleArrayDef.Attribute attribute){
        return m_exceptionTree.flatMap(t -> {
            if(t instanceof LoadException) return Optional.empty();
            // if the tree is not a leaf, it is typed to ConfigValueDoubleArrayDef.Attribute
            return ((LoadExceptionTree<ConfigValueDoubleArrayDef.Attribute>)t).getExceptionTree(attribute);
        });
    }
    ...
    @Override
    public java.util.List<Double> getArray() {
        return m_array;
    }
    ...
    public Optional<LoadException> getConfigTypeSupplyException(){
    	return getLoadExceptionTree(ConfigValueDoubleArrayDef.Attribute.CONFIG_TYPE).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getArraySupplyException(){
    	return getLoadExceptionTree(ConfigValueDoubleArrayDef.Attribute.ARRAY).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadExceptionTree<Integer>> getArrayExceptionTree(){
    	return getLoadExceptionTree(ConfigValueDoubleArrayDef.Attribute.ARRAY).map(les -> (LoadExceptionTree<Integer>)les);
    }
    ...
    public boolean equals(final Object o) {
        ...
        DefaultConfigValueDoubleArrayDef other = (DefaultConfigValueDoubleArrayDef)o;
