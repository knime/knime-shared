...
public class DefaultConfigValueDoubleArrayDef extends DefaultConfigValueArrayDef implements ConfigValueDoubleArrayDef, LoadExceptionTreeProvider {
    ...
    @JsonProperty("array")
    protected Optional<java.util.List<Double>> m_array;
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueDoubleArrayDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<ConfigValueDoubleArrayDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
    ...
    @Override
    public Optional<java.util.List<Double>> getArray() {
        return m_array;
    }
