...
public class DefaultConfigValueCharArrayDef extends DefaultConfigValueArrayDef implements ConfigValueCharArrayDef {
    ...
    DefaultConfigValueCharArrayDef(ConfigValueCharArrayDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof DefaultConfigValueCharArrayDef){
            var childTree = ((DefaultConfigValueCharArrayDef)toCopy).getLoadExceptionTree();                
