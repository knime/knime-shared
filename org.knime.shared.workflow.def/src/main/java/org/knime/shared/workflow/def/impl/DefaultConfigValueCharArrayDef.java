...
/**
 * DefaultConfigValueCharArrayDef
 *
...
public class DefaultConfigValueCharArrayDef extends DefaultConfigValueArrayDef implements ConfigValueCharArrayDef, LoadExceptionTreeProvider {
    ...
    @JsonProperty("array")
    protected Optional<java.util.List<Integer>> m_array;
     ...
     */
    DefaultConfigValueCharArrayDef(ConfigValueCharArrayDefBuilder builder) {
     ...
     */
    DefaultConfigValueCharArrayDef(ConfigValueCharArrayDef toCopy, final LoadException supplyException) {
     ...
     * @param toCopy source
     */
    public DefaultConfigValueCharArrayDef(ConfigValueCharArrayDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_array = toCopy.getArray();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultConfigValueCharArrayDef withException(ConfigValueCharArrayDef toCopy, final LoadException exception) {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueCharArrayDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<ConfigValueCharArrayDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
    ...
    @Override
    public Optional<java.util.List<Integer>> getArray() {
        return m_array;
    }
    ...
    public boolean equals(final Object o) {
        ...
        DefaultConfigValueCharArrayDef other = (DefaultConfigValueCharArrayDef)o;
