...
public class DefaultCreatorDef implements CreatorDef {
     ...
     */
    DefaultCreatorDef(CreatorDefBuilder builder) {
     ...
     */
    DefaultCreatorDef(CreatorDef toCopy, final LoadException supplyException) {
     ...
     * @param toCopy source
     */
    public DefaultCreatorDef(CreatorDef toCopy) {
        m_savedWithVersion = toCopy.getSavedWithVersion();
        m_nightly = toCopy.isNightly();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultCreatorDef withException(CreatorDef toCopy, final LoadException exception) {
    ...
    public boolean equals(final Object o) {
        ...
        DefaultCreatorDef other = (DefaultCreatorDef)o;
