...
/**
 * DefaultConfigValueLongArrayDef
 *
...
public class DefaultConfigValueLongArrayDef extends DefaultConfigValueArrayDef implements ConfigValueLongArrayDef {
     ...
     */
    DefaultConfigValueLongArrayDef(ConfigValueLongArrayDefBuilder builder) {
     ...
     */
    DefaultConfigValueLongArrayDef(ConfigValueLongArrayDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof DefaultConfigValueLongArrayDef){
            var childTree = ((DefaultConfigValueLongArrayDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public DefaultConfigValueLongArrayDef(ConfigValueLongArrayDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_array = toCopy.getArray();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultConfigValueLongArrayDef withException(ConfigValueLongArrayDef toCopy, final LoadException exception) {
    ...
    public boolean equals(final Object o) {
        ...
        DefaultConfigValueLongArrayDef other = (DefaultConfigValueLongArrayDef)o;
