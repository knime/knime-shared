...
public class DefaultConfigValueLongArrayDef extends DefaultConfigValueArrayDef implements ConfigValueLongArrayDef, LoadExceptionTreeProvider {
    ...
    @JsonProperty("array")
    protected Optional<java.util.List<Long>> m_array;
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueLongArrayDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<ConfigValueLongArrayDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
    ...
    @Override
    public Optional<java.util.List<Long>> getArray() {
        return m_array;
    }
