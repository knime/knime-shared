...
public class DefaultFilestoreDef implements FilestoreDef, LoadExceptionTreeProvider {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(FilestoreDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<FilestoreDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
