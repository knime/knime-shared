...
/**
 * ConfigValueLongArrayDef
 *
 * @author Martin Horn, KNIME GmbH, Konstanz, Germany
 * @author Carl Witt, KNIME AG, Zurich, Switzerland
 * @author Dionysios Stolis, KNIME GmbH, Berlin, Germany
 */
@JsonDeserialize(as = DefaultConfigValueLongArrayDef.class)
...
public interface ConfigValueLongArrayDef extends ConfigValueArrayDef {
    ...
    public enum Attribute implements DefAttribute {
          ...
          * Is is returned by {@link ConfigValueLongArrayDef#getConfigType} 
          */
         CONFIG_TYPE,
         /** 
          * The type of this data attribute is java.util.List&lt;Long&gt;.
          * Is is returned by {@link ConfigValueLongArrayDef#getArray} 
          */
         ARRAY,
;
    }
