...
/**
 * DefaultConnectionUISettingsDef
 *
...
public class DefaultConnectionUISettingsDef implements ConnectionUISettingsDef {

    /** this either points to a LoadException (which implements LoadExceptionTree<Void>) or to
     * a LoadExceptionTree<ConnectionUISettingsDef.Attribute> instance. */
    final private Optional<LoadExceptionTree<?>> m_exceptionTree;

    @JsonProperty("bendPoints")
    protected java.util.List<CoordinateDef> m_bendPoints;
    ...
    /**
     * Builder constructor. Only for use in {@link ConnectionUISettingsDefBuilder}.
     * @param builder source
     */
    DefaultConnectionUISettingsDef(ConnectionUISettingsDefBuilder builder) {
     ...
     * Only for use in {@link ConnectionUISettingsDefBuilder}.
     ...
     */
    DefaultConnectionUISettingsDef(ConnectionUISettingsDef toCopy, final LoadException supplyException) {
        Objects.requireNonNull(supplyException);
        toCopy = Objects.requireNonNullElse(toCopy, new ConnectionUISettingsDefBuilder().build());
        
        m_bendPoints = toCopy.getBendPoints();
        if(toCopy instanceof DefaultConnectionUISettingsDef){
            var childTree = ((DefaultConnectionUISettingsDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public DefaultConnectionUISettingsDef(ConnectionUISettingsDef toCopy) {
        m_bendPoints = toCopy.getBendPoints();
    ...
    // -----------------------------------------------------------------------------------------------------------------
    // Factory method to attach a LoadException to an existing ConnectionUISettings
    // -----------------------------------------------------------------------------------------------------------------
    /**
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultConnectionUISettingsDef withException(ConnectionUISettingsDef toCopy, final LoadException exception) {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConnectionUISettingsDef.Attribute attribute){
        return m_exceptionTree.flatMap(t -> {
            if(t instanceof LoadException) return Optional.empty();
            // if the tree is not a leaf, it is typed to ConnectionUISettingsDef.Attribute
            return ((LoadExceptionTree<ConnectionUISettingsDef.Attribute>)t).getExceptionTree(attribute);
        });
    }
    ...
    /**
     * @return The supply exception associated to bendPoints.
     */
    @JsonIgnore
    public Optional<LoadException> getBendPointsSupplyException(){
    	return getLoadExceptionTree(ConnectionUISettingsDef.Attribute.BEND_POINTS).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    @JsonIgnore
    @SuppressWarnings("unchecked")
    public Optional<LoadExceptionTree<Integer>> getBendPointsExceptionTree(){
    	return getLoadExceptionTree(ConnectionUISettingsDef.Attribute.BEND_POINTS).map(let -> (LoadExceptionTree<Integer>)let);
    }
    ...
    public boolean equals(final Object o) {
        ...
        DefaultConnectionUISettingsDef other = (DefaultConnectionUISettingsDef)o;
