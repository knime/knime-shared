...
public class DefaultCredentialPlaceholderDef implements CredentialPlaceholderDef, LoadExceptionTreeProvider {
     ...
     */
    DefaultCredentialPlaceholderDef() {
     ...
     */
    DefaultCredentialPlaceholderDef(CredentialPlaceholderDefBuilder builder) {
     ...
     */
    DefaultCredentialPlaceholderDef(CredentialPlaceholderDef toCopy, final LoadException supplyException) {
     ...
     * @param toCopy source
     */
    public DefaultCredentialPlaceholderDef(CredentialPlaceholderDef toCopy) {
        m_name = toCopy.getName();
        m_login = toCopy.getLogin();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultCredentialPlaceholderDef withException(CredentialPlaceholderDef toCopy, final LoadException exception) {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(CredentialPlaceholderDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<CredentialPlaceholderDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
    ...
    public boolean equals(final Object o) {
        ...
        DefaultCredentialPlaceholderDef other = (DefaultCredentialPlaceholderDef)o;
