...
public class DefaultCredentialPlaceholderDef implements CredentialPlaceholderDef {
    ...
    DefaultCredentialPlaceholderDef(CredentialPlaceholderDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof DefaultCredentialPlaceholderDef){
            var childTree = ((DefaultCredentialPlaceholderDef)toCopy).getLoadExceptionTree();                
