...
public class DefaultComponentMetadataDef extends DefaultNodeContainerMetadataDef implements ComponentMetadataDef {
    ...
    public Optional<LoadException> getAuthorSupplyException(){
    	return getLoadExceptionTree(ComponentMetadataDef.Attribute.AUTHOR).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getCreatedSupplyException(){
    	return getLoadExceptionTree(ComponentMetadataDef.Attribute.CREATED).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getLastModifiedSupplyException(){
    	return getLoadExceptionTree(ComponentMetadataDef.Attribute.LAST_MODIFIED).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadException> getTagsSupplyException(){
    	return getLoadExceptionTree(ComponentMetadataDef.Attribute.TAGS).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadExceptionTree<Integer>> getTagsExceptionTree(){
    	return getLoadExceptionTree(ComponentMetadataDef.Attribute.TAGS).map(les -> (LoadExceptionTree<Integer>)les);
    }
    ...
    public Optional<LoadException> getLinksSupplyException(){
    	return getLoadExceptionTree(ComponentMetadataDef.Attribute.LINKS).flatMap(LoadExceptionTree::getSupplyException);
    }
    ...
    public Optional<LoadExceptionTree<Integer>> getLinksExceptionTree(){
    	return getLoadExceptionTree(ComponentMetadataDef.Attribute.LINKS).map(let -> (LoadExceptionTree<Integer>)let);
    }
    ...
    public Optional<LoadException> getContentTypeSupplyException(){
    	return getLoadExceptionTree(ComponentMetadataDef.Attribute.CONTENT_TYPE).flatMap(LoadExceptionTree::getSupplyException);
    }
