...
public class DefaultConfigValueCharDef extends DefaultConfigValueDef implements ConfigValueCharDef, LoadExceptionTreeProvider {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueCharDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<ConfigValueCharDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
