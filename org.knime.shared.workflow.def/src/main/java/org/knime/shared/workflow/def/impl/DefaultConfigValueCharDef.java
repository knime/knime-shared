...
public class DefaultConfigValueCharDef extends DefaultConfigValueDef implements ConfigValueCharDef {
     ...
     */
    DefaultConfigValueCharDef(ConfigValueCharDefBuilder builder) {
     ...
     */
    DefaultConfigValueCharDef(ConfigValueCharDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof DefaultConfigValueCharDef){
            var childTree = ((DefaultConfigValueCharDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public DefaultConfigValueCharDef(ConfigValueCharDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_value = toCopy.getValue();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultConfigValueCharDef withException(ConfigValueCharDef toCopy, final LoadException exception) {
    ...
    public boolean equals(final Object o) {
        ...
        DefaultConfigValueCharDef other = (DefaultConfigValueCharDef)o;
