...
public class DefaultConfigValueFloatArrayDef extends DefaultConfigValueArrayDef implements ConfigValueFloatArrayDef, LoadExceptionTreeProvider {
    ...
    @JsonProperty("array")
    protected Optional<java.util.List<Float>> m_array;
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueFloatArrayDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<ConfigValueFloatArrayDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
    ...
    @Override
    public Optional<java.util.List<Float>> getArray() {
        return m_array;
    }
