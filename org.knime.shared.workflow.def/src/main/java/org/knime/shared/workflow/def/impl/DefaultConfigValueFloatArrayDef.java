...
/**
 * DefaultConfigValueFloatArrayDef
 *
...
public class DefaultConfigValueFloatArrayDef extends DefaultConfigValueArrayDef implements ConfigValueFloatArrayDef {
     ...
     */
    DefaultConfigValueFloatArrayDef(ConfigValueFloatArrayDefBuilder builder) {
     ...
     */
    DefaultConfigValueFloatArrayDef(ConfigValueFloatArrayDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof DefaultConfigValueFloatArrayDef){
            var childTree = ((DefaultConfigValueFloatArrayDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public DefaultConfigValueFloatArrayDef(ConfigValueFloatArrayDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_array = toCopy.getArray();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultConfigValueFloatArrayDef withException(ConfigValueFloatArrayDef toCopy, final LoadException exception) {
    ...
    public boolean equals(final Object o) {
        ...
        DefaultConfigValueFloatArrayDef other = (DefaultConfigValueFloatArrayDef)o;
