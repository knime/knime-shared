...
public class DefaultConfigValueDoubleDef extends DefaultConfigValueDef implements ConfigValueDoubleDef {
     ...
     */
    DefaultConfigValueDoubleDef(ConfigValueDoubleDefBuilder builder) {
     ...
     */
    DefaultConfigValueDoubleDef(ConfigValueDoubleDef toCopy, final LoadException supplyException) {
        ...
        if(toCopy instanceof DefaultConfigValueDoubleDef){
            var childTree = ((DefaultConfigValueDoubleDef)toCopy).getLoadExceptionTree();                
     ...
     * @param toCopy source
     */
    public DefaultConfigValueDoubleDef(ConfigValueDoubleDef toCopy) {
        m_configType = toCopy.getConfigType();
        m_value = toCopy.getValue();
     ...
     * @param exception supply exception, not null (use the copy constructor otherwise)
     */
    static DefaultConfigValueDoubleDef withException(ConfigValueDoubleDef toCopy, final LoadException exception) {
    ...
    public boolean equals(final Object o) {
        ...
        DefaultConfigValueDoubleDef other = (DefaultConfigValueDoubleDef)o;
