...
public class DefaultConfigValueDoubleDef extends DefaultConfigValueDef implements ConfigValueDoubleDef, LoadExceptionTreeProvider {
    ...
    public Optional<LoadExceptionTree<?>> getLoadExceptionTree(ConfigValueDoubleDef.Attribute attribute){
        ...
        return ((LoadExceptionTree<ConfigValueDoubleDef.Attribute>)m_exceptionTree).getExceptionTree(attribute);
    }
