...
public class ComponentMetadataDefBuilder {
     ...
     * @since 5.1
     */ 
    public ComponentMetadataDefBuilder setAuthor(final String author) {
     ...
     * {@code hasExceptions(ComponentMetadataDef.Attribute.AUTHOR)} will return true and and
     * {@code getExceptionalChildren().get(ComponentMetadataDef.Attribute.AUTHOR)} will return the exception.
     * 
     * @param author see {@link ComponentMetadataDef#getAuthor}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setAuthor(String)
     * @since 5.1
     */
    public ComponentMetadataDefBuilder setAuthor(final FallibleSupplier<String> author, String defaultValue) {
        java.util.Objects.requireNonNull(author, () -> "No supplier for author provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(ComponentMetadataDef.Attribute.AUTHOR);
        try {
            m_author = author.get();
	    } catch (Exception e) {
            ...
            m_exceptionalChildren.put(ComponentMetadataDef.Attribute.AUTHOR, supplyException);
	    }   
        return this;
    }
    // -----------------------------------------------------------------------------------------------------------------
     ...
     * @since 5.1
     */ 
    public ComponentMetadataDefBuilder setCreated(final OffsetDateTime created) {
     ...
     * Sets the field using a supplier that may throw an exception. If an exception is thrown, it is recorded and can
     * be accessed through {@link LoadExceptionTree} interface of the instance build by this builder.
     * {@code hasExceptions(ComponentMetadataDef.Attribute.CREATED)} will return true and and
     * {@code getExceptionalChildren().get(ComponentMetadataDef.Attribute.CREATED)} will return the exception.
     * 
     * @param created see {@link ComponentMetadataDef#getCreated}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setCreated(OffsetDateTime)
     * @since 5.1
     */
    public ComponentMetadataDefBuilder setCreated(final FallibleSupplier<OffsetDateTime> created, OffsetDateTime defaultValue) {
        java.util.Objects.requireNonNull(created, () -> "No supplier for created provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(ComponentMetadataDef.Attribute.CREATED);
        try {
            ...
            m_exceptionalChildren.put(ComponentMetadataDef.Attribute.CREATED, supplyException);
	    }   
        return this;
    }
    // -----------------------------------------------------------------------------------------------------------------
     ...
     * @since 5.1
     */ 
    public ComponentMetadataDefBuilder setLastModified(final OffsetDateTime lastModified) {
     ...
     * Sets the field using a supplier that may throw an exception. If an exception is thrown, it is recorded and can
     * be accessed through {@link LoadExceptionTree} interface of the instance build by this builder.
     * {@code hasExceptions(ComponentMetadataDef.Attribute.LAST_MODIFIED)} will return true and and
     * {@code getExceptionalChildren().get(ComponentMetadataDef.Attribute.LAST_MODIFIED)} will return the exception.
     * 
     * @param lastModified see {@link ComponentMetadataDef#getLastModified}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setLastModified(OffsetDateTime)
     * @since 5.1
     */
    public ComponentMetadataDefBuilder setLastModified(final FallibleSupplier<OffsetDateTime> lastModified, OffsetDateTime defaultValue) {
        java.util.Objects.requireNonNull(lastModified, () -> "No supplier for lastModified provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(ComponentMetadataDef.Attribute.LAST_MODIFIED);
        try {
            ...
            m_exceptionalChildren.put(ComponentMetadataDef.Attribute.LAST_MODIFIED, supplyException);
	    }   
        return this;
    }
    // -----------------------------------------------------------------------------------------------------------------
     ...
     * @since 5.1
     */
    public ComponentMetadataDefBuilder setTags(final java.util.List<String> tags) {
        setTags(() -> tags);
        return this;
    }
     ...
     * {@code hasExceptions(ComponentMetadataDef.Attribute.TAGS)} will return true and and
     * {@code getExceptionalChildren().get(ComponentMetadataDef.Attribute.TAGS)} will return the exception.
     * 
     * @param tags see {@link ComponentMetadataDef#getTags}
     * 
     * @return this builder for fluent API.
     * @see #setTags(java.util.List<String>)
     * @since 5.1
     */
    public ComponentMetadataDefBuilder setTags(final FallibleSupplier<java.util.List<String>> tags) {
        java.util.Objects.requireNonNull(tags, () -> "No supplier for tags provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(ComponentMetadataDef.Attribute.TAGS);
        try {
     ...
     * @since 5.1
     */
    public ComponentMetadataDefBuilder addToTags(String value){
    	addToTags(() -> value, /* default value will not be used */ value);
        return this;
    }
    
    /**
     * Adds the return value of the fallible supplier to the list returned by {@link ComponentMetadataDef#getTags}. If the 
     ...
     * @since 5.1
     */
    public ComponentMetadataDefBuilder addToTags(FallibleSupplier<String> value, String defaultValue) {
        String toAdd = null;
        try {
            toAdd = value.get();
        } catch (Exception e) {
     ...
     * @since 5.1
     */
    public ComponentMetadataDefBuilder setLinks(final java.util.List<LinkDef> links) {
        setLinks(() -> links);
        return this;
    }
     ...
     * {@code hasExceptions(ComponentMetadataDef.Attribute.LINKS)} will return true and and
     * {@code getExceptionalChildren().get(ComponentMetadataDef.Attribute.LINKS)} will return the exception.
     * 
     * @param links see {@link ComponentMetadataDef#getLinks}
     * 
     * @return this builder for fluent API.
     * @see #setLinks(java.util.List<LinkDef>)
     * @since 5.1
     */
    public ComponentMetadataDefBuilder setLinks(final FallibleSupplier<java.util.List<LinkDef>> links) {
        java.util.Objects.requireNonNull(links, () -> "No supplier for links provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(ComponentMetadataDef.Attribute.LINKS);
        try {
     ...
     * @since 5.1
     */
    public ComponentMetadataDefBuilder addToLinks(LinkDef value){
    	addToLinks(() -> value, /* default value will not be used */ value);
        return this;
    }
    
    /**
     * Adds the return value of the fallible supplier to the list returned by {@link ComponentMetadataDef#getLinks}. If the 
     * fallible supplier fails, adds the default value instead and registers a {@link LoadException} for the added element's index in the list.
     *
     ...
     * @since 5.1
     */
    public ComponentMetadataDefBuilder addToLinks(FallibleSupplier<LinkDef> value, LinkDef defaultValue) {
        LinkDef toAdd = null;
        try {
            toAdd = value.get();
        } catch (Exception e) {
     ...
     * @since 5.1
     */ 
    public ComponentMetadataDefBuilder setContentType(final ContentTypeEnum contentType) {
     ...
     * Sets the field using a supplier that may throw an exception. If an exception is thrown, it is recorded and can
     * be accessed through {@link LoadExceptionTree} interface of the instance build by this builder.
     * {@code hasExceptions(ComponentMetadataDef.Attribute.CONTENT_TYPE)} will return true and and
     * {@code getExceptionalChildren().get(ComponentMetadataDef.Attribute.CONTENT_TYPE)} will return the exception.
     * 
     * @param contentType see {@link ComponentMetadataDef#getContentType}
     * @param defaultValue is set in case the supplier throws an exception.
     * @return this builder for fluent API.
     * @see #setContentType(ContentTypeEnum)
     * @since 5.1
     */
    public ComponentMetadataDefBuilder setContentType(final FallibleSupplier<ContentTypeEnum> contentType, ContentTypeEnum defaultValue) {
        java.util.Objects.requireNonNull(contentType, () -> "No supplier for contentType provided.");
        // in case the setter was called before with an exception and this time there is no exception, remove the old exception
        m_exceptionalChildren.remove(ComponentMetadataDef.Attribute.CONTENT_TYPE);
        try {
            ...
            m_exceptionalChildren.put(ComponentMetadataDef.Attribute.CONTENT_TYPE, supplyException);
	    }   
        return this;
    }
    // -----------------------------------------------------------------------------------------------------------------
